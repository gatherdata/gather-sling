...
,isc.A.$36t=function(_1,_2,_3,_4,_5,_6){if(isc.isAn.Instance(_2))_1=_2.getClassName();else if(_2._constructor&&_2._constructor!="AdvancedCriteria")_1=_2._constructor;var _7=isc.Comm.$36u(_1,"Object",null,null,null,_6);var _8;_2=isc.JSONEncoder.$42b(_2);for(var _9 in _2){if(_9==null)continue;if(_9.startsWith('$'))continue;var _10=_2[_9];if(_10===_8)continue;if(isc.isA.Function(_10)&&!_10.iscAction)continue;var _11=_9.toString();var _12={objRefs:_4,objPath:isc.JSONEncoder.$zp(_3,_9),isRoot:false};_7=isc.StringBuffer.concat(_7,(_5!=null?isc.StringBuffer.concat("\r",_5,"\t"):""),isc.Comm.$ew(_11,_10,(_5!=null?isc.StringBuffer.concat(_5,"\t"):null),_12))}
_7=isc.StringBuffer.concat(_7,(_5!=null?isc.StringBuffer.concat("\r",_5):""),isc.Comm.$36v(_1));return _7}
...
,isc.A.isRefElement=function(_1){var _2=_1.getAttribute(this.$71v);if(_2&&_1.attributes.length==1&&!this.hasElementChildren(_1))return _2}
...
,isc.A.loadXMLSchema=function(_1,_2,_3,_4,_5){this.loadWSDL(_1,_2,_3,_4,_5,true)}
...
var _8={location:_1,callback:_2,autoLoadImports:_4,wsProperties:_5||{},returnSchemaSet:_6};isc.xml.loadXML(_1,function(_9){isc.xml.$37p(_9,_8)},_3)}
...
,isc.A.$37q=function(_1){var _2,_3;if(_1.returnSchemaSet){_2=isc.SchemaSet.$37r;_3="schemaSet"}else{_2=isc.WebService.$37r||isc.SchemaSet.$37r;_3="service"}
isc.WebService.$37r=isc.SchemaSet.$37r=null;_2.location=_1.location;if(_1.wsProperties)_2.setProperties(_1.wsProperties);if(_1.autoLoadImports&&_2.loadImports){var _4=this;_2.loadImports(function(){_4.$41k(_1.callback,_3,_2)})}else{this.$41k(_1.callback,_3,_2)}}
...
);isc.B._maxIndex=isc.C+53;isc.xml=isc.XML=isc.XMLTools;isc.defineClass("DataSource");isc.DS=isc.DataSource;isc.A=isc.DataSource;isc.A.dataSourceObjectSuffix="DS";isc.A._dataSources={};isc.A.$54v={};isc.A.$54w={};isc.A.$532="element";isc.A.$45t="type";isc.A.TABLE="table";isc.A.VIEW="view";isc.A.$37t="<soap:Envelope xmlns:soap='http://schemas.xmlsoap.org/soap/envelope/' ";isc.A.$37w="</soap:Envelope>";isc.A.$37u="<soap:Header>";isc.A.$51y="</soap:Header>";isc.A.$37v="<soap:Body";isc.A.$51z="</soap:Body>";isc.A=isc.DataSource;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.serializeTimeAsDatetime=false;isc.B.push(isc.A.isLoaded=function(_1){if(!_1)return false;if(isc.isA.DataSource(_1)||this._dataSources[_1])return true;return false}
...
,isc.A.updateCaches=function(_1,_2){var _3=_1.data,_4=_1.invalidateCache,_5=_1.httpResponseCode;if(!_3&&!_4&&!(_5>=200&&_5<300)){this.logWarn("Empty results returned on '"+_2.operationType+"' on dataSource '"+_2.dataSource+"', unable to update resultSet(s) on DataSource "+this.ID+".  Return affected records to ensure cache consistency.");return}
...
,isc.A.shouldBypassCache=function(_1,_2){var _3=this.getOperationBinding(_1,_2).preventHTTPCaching
if(_3==null)_3=this.preventHTTPCaching;return _3}
...
_1=isc.addProperties({},_1);var _5=this.getFields();for(var _6 in _5){var _7=_5[_6];if(isc.isA.Date(_1[_6]))
...
if(!this.sendExtraFields){var _8=_1.data;if(!isc.isAn.Array(_8))_8=[_8];for(var i=0;i<_8.length;i++){var _10=_8[i];if(!isc.isAn.Object(_10))continue;for(var _11 in _10){if(!this.getField(_11))delete _10[_11]}}}
var _12=this.transformRequest(_1);if(_12!==_1)_1.data=_12;if(_7){return{dataProtocol:"clientCustom"}}
...
var _13=this.getDataURL(_1);_13=_1.actionURL||_1.dataURL||_13;var _14,_15=_2.defaultParams||this.defaultParams,_16=_1.params;if(_15||_16){_14=isc.addProperties({},_15,_16)}
var _17=_6=="getParams"||_6=="postParams";if(_17){_14=isc.addProperties(_14||{},_1.data)}
if(_17){if(_14)_14=this.serializeFields(_14,_1);return{actionURL:_13,httpMethod:_1.httpMethod||(_6=="getParams"?"GET":"POST"),params:_14}}
var _18={actionURL:_13,httpMethod:_1.httpMethod||"POST"};if(_14)_18.params=_14;if(_6=="postMessage"){_18.data=(_1.data||"").toString()}
if(_6=="postXML"||_6=="soap"){var _19=this.getSerializeFlags(_1);var _20=_18.data=this.getXMLRequestBody(_1);_18.contentType=_1.contentType||"text/xml";this.logDebug("XML post requestBody is: "+_20,"xmlBinding")}
if(_6=="soap"){var _21=this.$du(_2.soapAction,_4.soapAction);if(_21==null)_21='""';_18.httpHeaders=isc.addProperties({SOAPAction:_21},_1.httpHeaders);var _22=isc.isA.WebService(_3)&&this.$du(_2.spoofResponses,this.spoofResponses);if(_22){_18.spoofedResponse=_3.getSampleResponse(_4.name);this.logInfo("Using spoofed response:\n"+_18.spoofedResponse,"xmlBinding")}}
...
return this}
,isc.A.getXMLRequestBody=function(_1,_2){if(isc.$cv)arguments.$cw=this;var _3=isc.SB.create(),_4=this.getDataProtocol(_1);if(_4=="soap"){_3.append(this.getSoapStart(_1),"\r");_3.append(this.getSoapBody(_1,_2));_3.append("\r",this.getSoapEnd(_1))}else{if(this.messageStyle=="template"){_3.append(this.$38d(_1))}else{var _5=this.getMessageSerializer(_1);var _2=this.getSerializerFlags(_1,_2);_3.append(_5.xmlSerialize(_1.data,_2))}}
...
,isc.A.getMessagePart=function(_1,_2,_3,_4){if(isc.$cv)arguments.$cw=this;var _5=this.getPartField(_1),_6=this.getSchema(_5.type,_5.xsElementRef?"element":null);if(isc.isA.DataSource(_6)){this.logInfo("soap:body part '"+_1+"' is complex type with schema: "+_6+" has value: "+(this.logIsDebugEnabled("xmlSerialize")?this.echo(_2):this.echoLeaf(_2)),"xmlSerialize");return _6.xmlSerialize(_2,_3,_4)}else{this.logInfo("soap:body part '"+_1+"' is of simple type '"+_5.type+"'"+" has value: '"+this.echoLeaf(_2),"xmlSerialize");return this.$38g(_5.name||_1,_5,_2,_5.partNamespace,_3)}}
...
return _10}
,isc.A.$38b=function(_1,_2,_3,_4,_5){if(!_2)_2={};if(_4!=null&&_5!=null){_2.httpResponseCode=_4.httpResponseCode;_2.transactionNum=_4.transactionNum;_2.clientContext=_5.clientContext}else{_2.clientContext=_3.clientContext}
...
if(_2.textMatchStyle==null)_2.textMatchStyle="substring";var _3={};_3.exportResults=true;_3.exportAs=_2.exportAs||"csv";_3.exportFilename=_2.exportFilename||"Results."+_3.exportAs;_2.exportFilename=_3.exportFilename;_3.exportDisplay=_2.exportDisplay||"download";_3.lineBreakStyle=_2.lineBreakStyle||"default";_3.exportFields=this.getExportableDSFields(_2.exportFields||this.getVisibleDSFields());_3.exportHeader=_2.exportHeader;_3.exportFooter=_2.exportFooter;_2.downloadResult=true;_2.downloadToNewWindow=_2.exportDisplay=="window"?true:false;if(_2.downloadToNewWindow){if(_3.exportFilename.endsWith(".xml")&&_3.exportAs!="xml"){_3.exportFilename=_3.exportFilename+".txt"}
...
,isc.A.performCustomOperation=function(_1,_2,_3,_4){if(!_4)_4={};isc.addProperties(_4,{operationId:_1});this.performDSOperation("custom",_2,_3,_4)}
...
,isc.A.performDSOperation=function(_1,_2,_3,_4){if(isc.$cv)arguments.$cw=this;var _5=isc.addProperties({operationType:_1,dataSource:this.ID,data:_2,callback:_3,requestId:this.$625()},_4);if(_5.sortBy!=null){if(!isc.isAn.Array(_5.sortBy))_5.sortBy=[_5.sortBy];for(var i=0;i<_5.sortBy.length;i++){var _7=_5.sortBy[i];if(!isc.isA.String(_7))continue;var _8=this.getField(_7.charAt(0)=="-"?_7.substring(1):_7);if(_8&&_8.canSortClientOnly)_5.sortBy[i]=null}
...
);isc.evalBoundary;isc.B.push(isc.A.performSCServerOperation=function(_1,_2){this.logWarn("Attempt to perform iscServer request requires options SmartClient server "+"support - not present in this build.\nRequest details:"+this.echo(_1));return}
...
,isc.A.getFlattenedFields=function(_1){_1=_1||{};var _2=this.getFieldNames();for(var i=0;i<_2.length;i++){var _4=_2[i],_5=this.getField(_4);if(!this.fieldIsComplexType(_4)){if(_1[_4]==null){_5.sourceDS=this.ID;_1[_4]=_5}}else{var _6=this.getFieldDataSource(_5);_6.getFlattenedFields(_1)}}
return _1}
...
,isc.A.combineFieldData=function(_1){var _2=this.getField(_1.name);return isc.DataSource.combineFieldData(_1,_2)}
...
,isc.A.recordsMatchingFilter=function(_1,_2,_3){var _4=isc.getKeys(_2),_5=_4.length,_6=[],_7,_8,_9,_10,_11,j;if(_3&&_3.operation&&this.operationBindings){var _13=_3.operation;if(_13.ID==_13.dataSource+"_"+_13.type){var _14=this.operationBindings.find("operationId",null)}else{var _14=this.operationBindings.find("operationId",_3.operation.ID)}
...
return 1}
return _7}
);isc.B._maxIndex=isc.C+142;isc.A=isc.DataSource;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$628=0;isc.A.$71l={sum:function(_1,_2,_3){var _4=0;for(var i=0;i<_2.length;i++){var _6=_1[_2[i].name],_7=parseFloat(_6);if(isc.isA.Number(_7)&&_7==_6){_4+=_7}else{return null}}
...
this.$71l[_1]=_2}
);isc.B._maxIndex=isc.C+9;isc.A=isc.DataSource.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.isAdvancedCriteria=function(_1){if(!_1)return false;if(_1._constructor=="AdvancedCriteria")return true;if(this.getField("fieldName")||this.getField("operator"))return false;if(this.getField(_1.fieldName)&&this.getSearchOperator(_1.operator)){return true}
return false}
...
,isc.A.getFieldOperators=function(_1){if(isc.isA.String(_1))_1=this.getField(_1);if(_1&&_1.validOperators)return _1.validOperators;var _2=isc.SimpleType.getType(_1.type);var _3=_1.type||"text";if(!_2)_3="text";if(_1)return this.getTypeOperators(_3);return[]}
...
);isc.B._maxIndex=isc.C+3;isc.DataSource.registerStringMethods({transformRequest:"dsRequest",transformResponse:"dsResponse,dsRequest,data"});isc.$571=function(){var _1=function(_57,_58,_59,_60,_61,_62){var _2;if(!_60.criteria){_60.criteria=[]}
...
var _11=_6.location?"logWarn":"logInfo";_1[_11](_10+"' could not find "+(_7?"webService":"SchemaSet")+" for namespace: '"+_8+"'. Pass autoLoadImports to loadWSDL()/loadXMLSchema() or "+"separately load via loadWSDL/loadXMLSchema jsp tag or method");continue}
...
var _3=this.getBindingOperation(_1,_2);var _4=this.getPortTypeOperation(_1,_2);if(!_3&&!_4){this.logWarn(this+": no such operation: 'operationName'");return null}
...
,isc.A.getByName=function(_1,_2){if(_2!=null){return this.services.find({name:_1,serviceNamespace:_2})}else{return this.services.find("name",_1)}}
...
if(isc.isA.Number(_1))_1=this.$38z.find({transactionNum:_1});if(_1&&_1.cleared)return null;return _1}
...
delete _4.$66o;delete _4.abortCallbacks;_4.receiveTime=isc.timeStamp();_4.changed();isc.RPCManager.$410.remove(_1);this.logInfo("transaction "+_1+" arrived after "+(_4.receiveTime-_4.sendTime)+"ms");if(_2==null){this.logFatal("No results for transaction "+_1);return false}
...
if(_6>299||_6<200){var _7=_4.URL;var _8;if(_4.isProxied){_7=_4.proxiedURL+" (via proxy: "+_7+")";if(_6>590){_8=(_6-500)*-1}}
_2=this.$39c(_4,{data:"Transport error - HTTP code: "+_6+" for URL: "+_7+(_6==302?" This error is likely the result"+" of a redirect to a server other than the origin"+" server or a redirect loop.":""),status:_8?_8:isc.RPCResponse.STATUS_TRANSPORT_ERROR});this.logDebug("RPC request to: "+_7+" returned with http response code: "+_6+". Response text:\n"+_5.responseText);_4.status=_8?_8:isc.RPCResponse.STATUS_TRANSPORT_ERROR;_4.$66n=true;this.handleTransportError(_1,_4.status,_4.httpResponseCode,_4.httpResponseText);if(_4.suspended||_4.abortCallbacks){delete _4.abortCallbacks;delete _4.$66n
return}
delete _4.$66n}}
...
,isc.A.createRPCResponse=function(_1,_2,_3){var _4=isc.addProperties({operationId:_2.operation.ID,clientContext:_2.clientContext,context:_2,transactionNum:_1.transactionNum,httpResponseCode:_1.httpResponseCode,httpResponseText:_1.httpResponseText,xmlHttpRequest:_1.xmlHttpRequest,transport:_1.transport,status:_1.status,clientOnly:_2.clientOnly},_3);if(_1.transport=="xmlHttpRequest"){isc.addProperties(_4,{httpHeaders:this.getHttpHeaders(_1.xmlHttpRequest)})}
return _4}
,isc.A.getHttpHeaders=function(_1){if(!_1){this.logWarn("getHttpHeaders called with a null XmlHttpRequest object");return null}
if(!isc.Browser.isIE&&!_1.getAllResponseHeaders){return null}
var _2;try{_2=_1.getAllResponseHeaders()}catch(e){this.logWarn("Exception thrown by xmlHttpRequest.getAllResponseHeaders(): "+e)}
if(!_2){this.logWarn("xmlHttpRequest.getAllResponseHeaders() returned null");return null}
var _3=_2.split('\n');var _4={};for(var i=0;i<_3.length;i++){if(_3[i].replace(/^\s+|\s+$/g,'')=="")continue;var _6=_3[i].indexOf(':');if(_6==-1){this.logWarn("GetAllResponseHeaders string had malformed entry at line "+1+".  Line reads "+_3[i]);continue}
var _7=_3[i].substring(0,_6);_4[_7]=_3[i].substring(_6+1).replace(/^\s+|\s+$/g,'');if(_4[_7]=="true")_4[_7]=true;if(_4[_7]=="false")_4[_7]=false}
if(_4["X-Proxied-Set-Cookie"]!=null){_4["Set-Cookie"]=_4["X-Proxied-Set-Cookie"]}
return _4}
...
var _3=_2.results;var _4=_2.operations,_5=[];_2.$66n=true;for(var i=0,j=0;i<_4.length;i++){var _8=_4[i];var _9=isc.addProperties(this.createRPCResponse(_2,_8),{callbackArgs:_2.transport=="scriptInclude"?_3:null,results:_3});if(_9.status==null)_9.status=0;_5[i]=_9;_2.responses[i]=_9;_2.changed()}
var _10=0;while(_10<_4.length&&!_2.suspended&&!_2.abortCallbacks)
{var _8=_4[_10],_9=_5[_10];this.performOperationReply(_8,_9);_10++}
if(_2.showPrompt)this.doClearPrompt(_2);if(!_2.suspended&&!_2.abortCallbacks){this.clearTransaction(_1)}
delete _2.abortCallbacks;delete _2.$66n;if(_2.offline)this.playbackNextOfflineTransaction();if(_2.$40c){var _11=_8.application?_8.application:this.getDefaultApplication();if(isc.isA.String(_11))_11=window[_11];_11.fireCallback(_2.$40c,"responses",[_2.responses])}}
...
,isc.A.dataSourceDataChanged=function(_1,_2){if(this.disableCacheSync)return;if(this.logIsDebugEnabled())this.logDebug("dataSource data changed firing");var _3=this.getDataSource().getUpdatedData(_1,_2,this.updateCacheFromRequest);this.handleUpdate(_1.operationType,_3,_2.invalidateCache,_1)}
...
var _7=isc.DataSource.getDataSource(this.dataSource);this.observe(_7,"dataChanged","observer.dataSourceDataChanged(dsRequest,dsResponse);");if(!this.isMultiDSTree()){if(!this.root)this.root=this.makeRoot();var _8=this.getTreeRelationship(this.root);var _9;if(this.rootValue===_9)this.rootValue=_8.rootValue;if(!this.loadDataOnDemand&&(this.rootValue!=null||(this.root!=null&&this.root[this.idField]!=null))&&this.discardParentlessNodes==null)
{this.discardParentlessNodes=true}
if(this.idField==null)this.idField=_8.idField;if(this.parentIdField==null)this.parentIdField=_8.parentIdField;if(_8.childrenProperty)this.childrenProperty=_8.childrenProperty;this.root[this.idField]=this.rootValue}
...
,isc.A.addCacheData=function(_1){if(!isc.isAn.Array(_1))_1=[_1];var _2=this.getDataSource().applyFilter(_1,this.criteria,this.context);var _3=this.getDataSource().getPrimaryKeyFieldNames()[0];for(var i=0;i<_2.length;i++){this.$651(_2[i],_3)}}
...
return}
this.logWarn("saveData() called on a non-databound DynamicForm. This is not supported. "+" for information on databinding of components look at the documentation"+" for the DataSource class.  "+"If this was intended to be a native HTML form submission, set the "+"canSubmit property to true on this form.");return}
...
var _7=this.getSaveOperationType(_2);this.$40c=_1;_1=this.getID()+".$49z(dsRequest, dsResponse, data)";_2=this.buildRequest(_2,_7,_1);_2.oldValues=this.$10s;var _8=false;if(this.submitParamsOnly)_2.useSimpleHttp=true;if(isc.DynamicForm&&isc.isA.DynamicForm(this)){if(this.$66g){_2.actionURL=this.action;_2.target=this.target?this.target:window;_8=true}
...
_3=_2._constructor}else{if(isc.isAn.Array(_2))_2=_2[0];_3=_2.className||_2.type}
...
return false}}
this.logInfo(this.ID+" is accepting the "+_3+" drop");var _6=this.findEditNode(_3);if(_6){if(_1!=false){this.logInfo(this.ID+": selecting editNode object "+_6.ID);if(_4)isc.EditContext.hideDragHandle();isc.SelectionOutline.select(_6,false);_6.clearNoDropIndicator()}
...
return this}
,isc.A.canAdd=function(_1){return(this.getObjectField(_1)!=null)}
...
,isc.A.shouldPassDropThrough=function(){var _1=isc.EH.dragTarget,_2,_3;if(!_1.isA("Palette")){_3=_1.isA("FormItemProxyCanvas")?_1.formItem._constructor:_1._constructor}else{_2=_1.getDragData();if(isc.isAn.Array(_2))_2=_2[0];_3=_2.className||_2.type}
...
var _1=isc.EH.dragTarget,_2,_3;if(!_1.isA("Palette")){_3=_1._constructor}else{_2=_1.transferDragData();if(isc.isAn.Array(_2))_2=_2[0];_2.dropped=true;_3=_2.className||_2.type}
if(!_1.isA("Palette")){if(isc.EditContext.$70r)isc.EditContext.$70r.hide();if(_1==this)return;var _4=this.editContext.data,_5=_4.getParent(_1.editNode);this.editContext.removeComponent(_1.editNode);var _6=this.editContext.addNode(_1.editNode,this.editNode);;if(_6&&_6.liveObject){isc.EditContext.selectCanvasOrFormItem(_6.liveObject,true)}}else{if(_2.loadData&&!_2.isLoaded){var _7=this;_2.loadData(_2,function(_8){_8=_8||_2
_8.isLoaded=true;_7.completeItemDrop(_8)
_8.dropped=_2.dropped});return isc.EH.STOP_BUBBLING}
this.completeItemDrop(_2);return isc.EH.STOP_BUBBLING}}
,isc.A.completeItemDrop=function(_1){this.editContext.addComponent(_1,this.editNode)}
...
return isc.EH.STOP_BUBBLING}}
);isc.B._maxIndex=isc.C+15;isc.A=isc.Class.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.getSchema=function(){return isc.DS.get(this.schemaName||this.Class)}
...
for(var i=0;i<_1.length;i++){var _5=isc.isAn.Object(_1[i])?_1[i].name:_1[i];if(this.editModeOriginalValues[_5]!==_2){this[_5]=this.editModeOriginalValues[_5];delete this.editModeOriginalValues[_5]}else{}}}
...
);isc.B._maxIndex=isc.C+2;isc.A=isc.TabSet;isc.A.addTabEditorHint="Enter tab titles (comma separated)";isc.A=isc.TabSet.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.setEditMode=function(_1,_2,_3){if(_1==null)_1=true;if(_1==this.editingOn)return;this.invokeSuper(isc.TabSet,"setEditMode",_1,_2,_3);if(this.editingOn){for(var i=0;i<this.tabs.length;i++){var _5=this.tabs[i];this.saveOriginalValues(_5);this.setCanCloseTab(_5,true)}
...
,isc.A.editModeAddTabs=function(_1){if(!_1||_1==isc.TabSet.addTabEditorHint)return;var _2=_1.split(",");for(var i=0;i<_2.length;i++){var _4={type:"Tab",initData:{title:_2[i]}};this.editContext.addComponent(this.editContext.makeEditNode(_4),this.editNode)}}
...
if(!_1.isA("Palette")){if(isc.EditContext.$70r)isc.EditContext.$70r.hide();if(_1==this)return;var _5=this.editContext.data,_6=_5.getParent(_1.editNode),_7=_5.getChildren(_6).indexOf(_1.editNode),_8=this.getDropPosition(_3);this.editContext.removeComponent(_1.editNode);if(_6==this.editNode&&_8>_7)_8--;var _9=this.editContext.addNode(_1.editNode,_4,_8);if(isc.isA.TabSet(_4.liveObject)){_4.liveObject.selectTab(_1)}else if(_9&&_9.liveObject){isc.EditContext.selectCanvasOrFormItem(_9.liveObject,true)}}else{if(this.parentElement&&this.parentElement.hideDropLine){this.parentElement.hideDropLine()}
var _10=this.editContext.addComponent(_2,_4,this.getDropPosition(_3));if(_10!=null){var _11=_2.liveObject;if(isc.isA.TabSet(_4.liveObject)){_4.liveObject.selectTab(_11)}
if(isc.isA.TabSet(_11)){_11.delayCall("showAddTabEditor")}else if(isc.isA.ImgTab(_11)||isc.isA.Button(_11)||isc.isA.StretchImgButton(_11)||isc.isA.SectionHeader(_11)||isc.isA.ImgSectionHeader(_11)){_11.delayCall("editClick")}}}
this.hideDropLine();return isc.EH.STOP_BUBBLING}
,isc.A.editModeDropMove=function(){if(!this.editModeWillAcceptDrop())return false;if(!this.shouldPassDropThrough()){this.Super("dropMove",arguments);if(this.parentElement&&this.parentElement.hideDropLine){this.parentElement.hideDropLine();if(isc.isA.FormItem(this.parentElement)){this.parentElement.form.hideDragLine()}}
return isc.EH.STOP_BUBBLING}else{this.hideDropLine()}}
,isc.A.editModeDropOver=function(){if(!this.editModeWillAcceptDrop())return false;if(!this.shouldPassDropThrough()){this.Super("dropOver",arguments);if(this.parentElement&&this.parentElement.hideDropLine){this.parentElement.hideDropLine();if(isc.isA.FormItem(this.parentElement)){this.parentElement.form.hideDragLine()}}
return isc.EH.STOP_BUBBLING}else{this.hideDropLine()}}
);isc.B._maxIndex=isc.C+4;if(isc.DynamicForm){isc.A=isc.DynamicForm.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.dropMargin=10;isc.B.push(isc.A.setEditMode=function(_1,_2,_3){if(_1==null)_1=true;if(_1==this.editingOn)return;this.invokeSuper(isc.DynamicForm,"setEditMode",_1,_2,_3);if(this.editingOn){this.saveToOriginalValues(["canAcceptDrop","canDropItems","canDropComponents","canAddColumns","drop","dropMove","dropOver","dropOut","setDataSource"]);this.setProperties({canAcceptDrop:true,canDropItems:true,canDropComponents:true,canAddColumns:true,drop:this.editModeDrop,dropMove:this.editModeDropMove,dropOut:this.editModeDropOut,dropOver:this.editModeDropOver,setDataSource:this.editModeSetDataSource});this.resetValues();var _4=this.dropMargin;if(_4*2>this.getVisibleHeight()-10){_4=Math.round((this.getVisibleHeight()-10)/2);if(_4<2)_4=2;this.dropMargin=_4}}else{this.restoreFromOriginalValues(["canAcceptDrop","canDropItems","canDropComponents","canAddColumns","drop","dropMove","dropOver","dropOut","setDataSource"]);this.resetValues()}}
,isc.A.editModeSetDataSource=function(_1,_2){if(_1==this.dataSource||_1==null)return;this.dataSource=_1;var _3=this.items?this.items.length:0,_4=false;for(var i=0;i<_3;i++){var _6=this.items[i];if(_6.editNode.autoGen&&this.fieldChanged(_6)){_4=true;break}}
if(!_4)
for(var i=0;i<this.items.length;){var _6=this.items[i];if(_6.editNode.autoGen){this.editContext.removeComponent(_6.editNode)}else{i++}}
if((!_4||_3==0)&&_1.fields){for(var _7 in _1.fields){var _6=_1.fields[_7];if(_6.hidden)continue;var _8=this.getEditorType(_6.type);_8=_8.substring(0,1).toUpperCase()+_8.substring(1)+"Item";var _9={type:_8,autoGen:true,defaults:{name:_6.name}}
var _10=this.editContext.makeEditNode(_9);this.editContext.addComponent(_10,this.editNode)}}
this.setData({})}
,isc.A.fieldChanged=function(_1){return _1.editNode.$71u}
,isc.A.editModeDropOver=function(){if(!this.editModeWillAcceptDrop())return false;this.$69c=null;this.hideDragLine();return isc.EH.STOP_BUBBLING}
,isc.A.editModeDropMove=function(){if(!this.ns.EH.getDragTarget())return false;if(this.canDropItems!=true)return false;if(!this.editModeWillAcceptDrop())return false;var _1=this.ns.EH.getDragTarget().getDragData();if(isc.isAn.Array(_1))_1=_1[0];if(_1!=null&&(_1.type=="DataSource"||_1.className=="DataSource")){return isc.EH.STOP_BUBBLING}
if(this.getItems().length==0){if(this.shouldPassDropThrough()){this.hideDragLine();return}
if(this.parentElement){if(this.parentElement.hideDragLine)this.parentElement.hideDragLine();if(this.parentElement.hideDropLine)this.parentElement.hideDropLine()}
this.showDragLineForForm();return isc.EH.STOP_BUBBLING}
...
if(_3){if(this.parentElement){if(this.parentElement.hideDragLine)this.parentElement.hideDragLine();if(this.parentElement.hideDropLine)this.parentElement.hideDropLine()}
this.showDragLineForItem(_4,_2.x,_2.y)}else{if(this.shouldPassDropThrough()){this.hideDragLine();return}
if(_4){this.showDragLineForItem(_4,_2.x,_2.y)}else{this.hideDragLine()}}
...
var _2=this.$69c,_3=this.getItemTableOffsets(_2),_4=_2.dropSide,_5=_2.$69d,_6=this.getItemDropIndex(_2,_4);if(_6!=null&&_6>=0){if(this.parentElement){if(this.parentElement.hideDragLine)this.parentElement.hideDragLine();if(this.parentElement.hideDropLine)this.parentElement.hideDropLine()}
var _7=this.items.$8j.duplicate();this.modifyFormOnDrop(_2,_3.top,_3.left,_4,_7)}
this.$69c=null;if(this.shouldPassDropThrough()){this.hideDragLine();return}
return isc.EH.STOP_BUBBLING}
...
if(!_1.isA("Palette")){if(isc.EditContext.$70r)isc.EditContext.$70r.hide();var _8=this.editContext.data,_9=_8.getParent(_7.editNode),_10=_8.getChildren(_9).indexOf(_7.editNode),_11=_7.editNode;this.editContext.removeComponent(_11);if(_9==this.editNode&&_2>_10)_2--;if(isc.isA.Function(this.itemDropping)){_11=this.itemDropping(_11,_2,true);if(!_11)return}
var _12=this.editContext.addNode(_7.editNode,this.editNode,_2);if(_12&&_12.liveObject)isc.EditContext.selectCanvasOrFormItem(_12.liveObject,true);return _12}else{var _13=_1.transferDragData();if(isc.isAn.Array(_13))_13=_13[0];if(_13.loadData&&!_13.isLoaded){var _14=this;_13.loadData(_13,function(_15){_15=_15||_13
...
,isc.A.completeItemDrop=function(_1,_2,_3,_4,_5,_6){var _7=_1.liveObject,_8;if(!isc.isA.FormItem(_7)){if(isc.isA.Button(_7)||isc.isAn.IButton(_7)){_1=this.editContext.makeEditNode({type:"ButtonItem",title:_7.title})}else if(isc.isA.Canvas(_7)){_8=_1;_1=this.editContext.makeEditNode({type:"CanvasItem"});isc.addProperties(_1.initData,{showTitle:false,startRow:true,endRow:true,width:"*",colSpan:"*"})}}
_1.dropped=true;if(isc.isA.Function(this.itemDropping)){_1=this.itemDropping(_1,_2,true);if(!_1)return}
var _9=this.editContext.addComponent(_1,this.editNode,_2);if(_9){if(_8)this.editContext.addComponent(_8,_9,0);isc.EditContext.selectCanvasOrFormItem(_1.liveObject,true);if(_9.showTitle!=false){_1.liveObject.delayCall("editClick")}}
if(_6)this.fireCallback(_6,"node",[_9])}
,isc.A.modifyFormOnDrop=function(_1,_2,_3,_4,_5){if(this.canAddColumns==false)return;var _6=this.ns.EH.getDragTarget().getDragData(),_7,_8,_9;if(!_6){_6=this.ns.EH.getDragTarget();if(!isc.isA.FormItemProxyCanvas(_6)){this.logWarn("In modifyFormOnDrop the drag target was not a FormItemProxyCanvas");return}
_6=_6.formItem;var _10=-1;for(var i=0;i<_5.length;i++){for(var j=0;j<_5[i].length;j++){if(_5[i][j]==_10)continue;_10=_5[i][j];if(this.items[_10]==_6){_8=i;_9=_10;break}}}
var _13=true}else{if(isc.isAn.Array(_6))_6=_6[0];var _14=_6.type||_6.className;var _15=isc.ClassFactory.getClass(_14);if(isc.isA.FormItem(_15)){_6=this.createItem(_6,_14)}else{_6=this.createItem({type:"CanvasItem",showTitle:false},"CanvasItem")}
var _13=false}
...
var _16=[];if(_13&&_8){var _17=_5[_8],_10=-1;for(var i=0;i<_17.length;i++){if(_17[i]!=_10){_10=_17[i];if(this.items[_10]==_6)continue;if(isc.isA.SpacerItem(this.items[_10])&&this.items[_10].$71m)
{this.logDebug("Marking spacer "+this.items[_10].name+" for removal","formItemDragDrop");_16.add(this.items[_10]);continue}
this.logDebug("Found a non-spacer item on row "+_8+", no spacers will be deleted","formItemDragDrop");_16=null;break}}}
if(_4=="L"||_4=="R"){var _18=true;if(_6.startRow)_18=false;if(_6.endRow&&(_4=="L"||_3<_5[_2].length)){_18=false}
if(_13&&_8==_2)_18=false;if(_18){var _19=_7;var _20=_5[_2][_3];if(_4=="R")_20++;if(_5[_2].contains(_20)){var _21=this.items[_20];if(!isc.isA.SpacerItem(_21)||!_21.$71m){_20+=_4=="L"?-1:1;_21=this.items[_20]}
if(_5[_2].contains(_20)){if(isc.isA.SpacerItem(_21)&&_21.$71m){if(_21.colSpan&&_21.colSpan>_19){_21.editContext.setNodeProperties(_21.editNode,{colSpan:_21.colSpan-_19});_19=0}else{_19-=_21.colSpan;_21.editContext.removeComponent(_21.editNode)}}}}
if(_19<=0){_18=false}else if(_5[_2].length+_7<=this.numCols){_18=false}else{this.editContext.setNodeProperties(this.editNode,{numCols:this.numCols+_19})}}
var _22=0;for(var i=0;i<_5.length;i++){var _20=_5[i][_3];if(_20==null)_20=this.items.length;else _20+=_22+(_4=="L"?0:1);if(i!=_2){if(!_18)continue;if(_13&&_8&&_2<_8&&i==_8)
{_22--}
if(_16&&_16.length>0&&i==_8){continue}
var _21=this.items[_20-1];if(!_21||_21==_6||_21.endRow)continue;var _23=this.getAdjustedColSpan(_21);if(_4=="R"&&_3+_23>=_5[i].length){if(!_21.endRow){_21.editContext.setNodeProperties(_21.editNode,{endRow:true,$71n:true})}
continue}
var _24=this.editContext.makeEditNode({type:"SpacerItem"});isc.addProperties(_24.initData,{colSpan:_19,$71m:true});var _25=this.editContext.addComponent(_24,this.editNode,_20);_22++}else{if(_4=="L"){var _21=this.items[_20];if(_21&&_21.startRow&&_21.$71r){_21.editContext.setNodeProperties(_21.editNode,{startRow:null,$71r:null})}}else{var _21=this.items[_20-1];if(_21&&_21.endRow&&_21.$71n){_21.editContext.setNodeProperties(_21.editNode,{endRow:null,$71n:null})}}
this.itemDrop(this.ns.EH.getDragTarget(),_20,i,_3,_4);if(_8&&_2<_8)_22++}}}else{var _26,_27;if(isc.isA.SpacerItem(_1)&&_1.$71m){_26=_2}else{_26=_2+(_4=="B"?1:0)}
if(_5[_26])_27=_5[_26][_3];var _28;if(_26>=_5.length)_28=this.items.length;else _28=_5[_26][0];var _29=_27==null?null:this.items[_27];if(_29==null||(isc.isA.SpacerItem(_29)&&_29.$71m)){if(_26>_5.length-1||_26<0){if(_3!=0&&!_6.startRow){var _24=this.editContext.makeEditNode({type:"SpacerItem"});isc.addProperties(_24.initData,{colSpan:_3,$71m:true});this.editContext.addComponent(_24,this.editNode,_28)}
this.itemDrop(this.ns.EH.getDragTarget(),_28+(_3!=0?1:0),_26,_3,_4)}else if(_29==null){var _30=_5[_26].length-1;if(_30<0){isc.logWarn("Found completely empty row in DynamicForm at position ("+_26+","+(_3)+")");return}
var _31=_5[_26][_30];var _21=this.items[_31];if(_21==null){isc.logWarn("Null item in DynamicForm at position ("+_26+","+(_3-1)+")");return}
if(_21.endRow&&_21!=_6){_21.editContext.setNodeProperties(_21.editNode,{endRow:false})}
var _32=(_3-_30)-1;if(_13&&_21==_6){_32+=_7}
if(_32>0){var _24=this.editContext.makeEditNode({type:"SpacerItem"});isc.addProperties(_24.initData,{colSpan:_32,$71m:true});this.editContext.addComponent(_24,this.editNode,_31+1)}
this.itemDrop(this.ns.EH.getDragTarget(),_31+(_32>0?2:1),_26,_3,_4)}else{var _33=_29.colSpan?_29.colSpan:1,_34=_7;if(_33>_34){_29.editContext.setNodeProperties(_29.editNode,{colSpan:_33-_34});this.itemDrop(this.ns.EH.getDragTarget(),_27,_26,_3,_4)}else{this.itemDrop(this.ns.EH.getDragTarget(),_27,_26,_3,_4);_29.editContext.removeComponent(_29.editNode)}}}else{if(_3!=0){var _24=this.editContext.makeEditNode({type:"SpacerItem"});isc.addProperties(_24.initData,{colSpan:_3,$71m:true});this.editContext.addComponent(_24,this.editNode,_28)}
this.itemDrop(this.ns.EH.getDragTarget(),_28+(_3==0?0:1),_26,_3,_4,function(_35){if(_35&&_35.liveObject&&_35.liveObject.editContext){_35.liveObject.editContext.setNodeProperties(_35,{endRow:true,$71n:true})}})}}
if(_13&&_16){for(var i=0;i<_16.length;i++){this.logDebug("Removing spacer item "+_16[i].name,"formItemDragDrop");_16[i].editContext.removeComponent(_16[i].editNode)}}
if(!_13)_6.destroy()}
...
);isc.B._maxIndex=isc.C+13;isc.A=isc.FormItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.setEditMode=function(_1,_2,_3){if(_1==null)_1=true;if(this.editingOn==_1)return;this.editingOn=_1;if(this.editingOn){this.editContext=_2}
...
isc.A=isc.SectionStack.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.canAdd=function(_1){if(_1=="SectionStackSection")return true;var _2=isc.ClassFactory.getClass(_1);if(_2&&_2.isA("Canvas"))return true;return false}
...
return _2}
,isc.A.getDropPosition=function(_1){var _2=this.invokeSuper(isc.SectionStack,"getDropPosition");if(!_1||_1=="SectionStackSection"){return _2}
...
return _1}
);isc.B._maxIndex=isc.C+4;isc.A=isc.ListGrid.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.setEditMode=function(_1,_2,_3){if(_1==null)_1=true;if(_1==this.editingOn)return;this.invokeSuper(isc.ListGrid,"setEditMode",_1,_2,_3);if(this.editingOn){this.saveToOriginalValues(["setNoDropIndicator","clearNoDropIndicator"]);this.setProperties({setNoDropIndicator:this.editModeSetNoDropIndicator,clearNoDropIndicator:this.editModeClearNoDropIndicator})}else{this.restoreFromOriginalValues(["setNoDropIndicator","clearNoDropIndicator"])}}
,isc.A.editModeClearNoDropIndicator=function(_1){this.invokeSuper(isc.ListGrid,"clearNoDropIndicator",_1);this.body.editModeClearNoDropIndicator()}
...
);isc.B._maxIndex=isc.C+3;isc.ClassFactory.defineInterface("EditContext");isc.A=isc.EditContext;isc.A.$70s=-18;isc.A.$70t=0;isc.A=isc.EditContext;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.manageTitleEditor=function(_1,_2,_3,_4,_5){if(!isc.isA.DynamicForm(this.titleEditor)){this.titleEditor=isc.DynamicForm.create({autoDraw:false,margin:0,padding:0,cellPadding:0,fields:[{name:"title",type:"text",showTitle:false,keyPress:function(_9,_11,_12){if(_12=="Escape"){_11.discardUpdate=true;_11.hide();return}
if(_12=="Enter")_9.blurItem()},blur:function(_11,_9){if(!_11.discardUpdate){var _6=_11.targetComponent,_7=_6.editContext;if(_7){_7.setNodeProperties(_6.editNode,{"title":_9.getValue()})}}
_11.hide()}}]})}
...
,isc.A.selectCanvasOrFormItem=function(_1,_2){if(this.$70r)this.$70r.hide();var _3=isc.SelectionOutline.getSelectedObject();if(_3&&this.observer){this.observer.ignore(_3,"dragMove");_3.restoreFromOriginalValues(["canDrag","canDrop","dragAppearance","dragStart","dragMove","dragStop","setDragTracker"])}
_1.saveToOriginalValues(["canDrag","canDrop","dragAppearance","dragStart","dragMove","dragStop","setDragTracker"]);_1.setProperties({canDrop:true,dragAppearance:"outline",dragStart:function(){return true},dragMove:function(){return true},setDragTracker:function(){isc.EH.setDragTracker("");return false},dragStop:function(){isc.EditContext.hideProxyCanvas();isc.EditContext.positionDragHandle()}});var _4=_1.editContext.creator;isc.SelectionOutline.select(_1,false,!(_2&&_4.hideLabelWhenSelecting));if(_1.editingOn){this.showSelectedObjectDragHandle();var _5=_1.editContext;if(_5.selectRecord){_5.deselectAllRecords();if(isc.isA.Canvas(_1)){if(isc.isA.SectionHeader(_1)||isc.isA.ImgSectionHeader(_1)){_5.selectRecord(_5.data.findById(_1.$42i))}else{_5.selectRecord(_5.data.findById(_1.ID))}}else{_5.selectRecord(_5.data.find({ID:_1.name}))}}
_5.creator.editComponent(_1.editNode,_1)}}
,isc.A.showSelectedObjectDragHandle=function(){if(!this.$70r){this.$70r=isc.Img.create({src:"[SKIN]/../../ToolSkin/images/controls/dragHandle.gif",prompt:"Grab here to drag component",width:18,height:18,cursor:"move",backgroundColor:"white",opacity:80,canDrag:true,canDrop:true,isMouseTransparent:true,mouseDown:function(){this.dragIconOffsetX=isc.EH.getX()-
isc.EditContext.draggingObject.getPageLeft();this.dragIconOffsetY=isc.EH.getY()-
isc.EditContext.draggingObject.getPageTop();this.Super("mouseDown",arguments)}})}
if(this.draggingObject){this.observer.ignore(this.draggingObject,"dragMove");this.observer.ignore(this.draggingObject,"hide");this.observer.ignore(this.draggingObject,"destroy")}
var _1=isc.SelectionOutline.getSelectedObject();if(isc.isA.FormItem(_1)){if(!this.$70y){this.$70y=isc.FormItemProxyCanvas.create()}
this.$70y.delayCall("setFormItem",[_1]);_1=this.$70y}
this.$70r.setProperties({dragTarget:_1});isc.Timer.setTimeout("isc.EditContext.positionDragHandle()",0);if(!this.observer)this.observer=isc.Class.create();this.draggingObject=_1;this.observer.observe(this.draggingObject,"dragMove","isc.EditContext.positionDragHandle(true)");this.observer.observe(this.draggingObject,"hide","isc.EditContext.$70r.hide()");this.observer.observe(this.draggingObject,"destroy","isc.EditContext.$70r.hide()");this.$70r.show()}
,isc.A.hideProxyCanvas=function(){if(this.$70y)this.$70y.hide()}
,isc.A.positionDragHandle=function(_1){var _2=this.draggingObject;if(!_2)return;var _3=_2.getPageLeft()+this.$70s;if(_1){_3+=_2.getOffsetX()-this.$70r.dragIconOffsetX}
this.$70r.setLeft(_3);var _4=_2.getPageTop()+this.$70t;if(_1){_4+=_2.getOffsetY()-this.$70r.dragIconOffsetY}
this.$70r.setTop(_4);this.$70r.bringToFront()}
,isc.A.hideDragHandle=function(){if(this.$70r)this.$70r.hide()}
,isc.A.showDragHandle=function(){if(this.$70r)this.$70r.show()}
);isc.B._maxIndex=isc.C+8;isc.EditContext.addInterfaceMethods({addFromPaletteNode:function(_1,_2){var _3=isc.HiddenPalette.create();var _4=_3.makeEditNode(_1);return this.addNode(_4,_2)},makeEditNode:function(_1){var _2=isc.HiddenPalette.create();return _2.makeEditNode(_1)},requestLiveObject:function(_1,_2,_3){var _4=this;if(_1.loadData&&!_1.isLoaded){_1.loadData(_1,function(_6){_6=_6||_1
_6.isLoaded=true;_6.dropped=_1.dropped;_4.fireCallback(_2,"node",[_6])},_3);return}
if(_1.wizardConstructor){this.logWarn("creating wizard");var _5=isc.ClassFactory.newInstance(_1.wizardConstructor,_1.wizardDefaults);_5.getResults(_1,function(_6){if(!_6.liveObject){_6=_3.makeEditNode(_6)}
...
return _2},enableEditing:function(_1){var _2=_1.liveObject;if(_2.setEditMode)_2.setEditMode(true,this,_1)},setNodeProperties:function(_1,_2){isc.addProperties(_1.initData,_2);_1.$71u=true;var _3=_1.liveObject;if(isc.isA.FormItem(_3)&&_2.name!=null){var _4=this.data,_5=_4.getParent(_1),_6=_4.getChildren(_5).findIndex(_1);this.removeComponent(_1);_1.name=_1.ID=_2.name;delete _2.name;this.addComponent(_1,_5,_6);_3=this.getLiveObject(_1)}
if(_1.initData.ID!=null)_1.ID=_1.initData.ID;if(_3.setEditorProperties){_3.setEditorProperties(_2);if(_3.markForRedraw)_3.markForRedraw();else if(_3.redraw)_3.redraw()}else{isc.addProperties(_3,_2);var _5=this.data.getParent(_3);if(_5&&_5.liveObject&&_5.liveObject.markForRedraw)
{_5.liveObject.markForRedraw()}}
this.markForRedraw()}});isc.ClassFactory.defineInterface("Palette");isc.Palette.addInterfaceMethods({makeEditNode:function(_1){return this.makeNewComponent(_1)},makeNewComponent:function(_1){if(!_1)_1=this.getDragData();if(isc.isAn.Array(_1))_1=_1[0];var _2=_1.className||_1.type;var _3={type:_2,_constructor:_2,title:_1.title,icon:_1.icon,iconSize:_1.iconSize,showDropIcon:_1.showDropIcon,autoGen:_1.autoGen};if(isc.isAn.Object(_1.editNodeProperties)){for(var _4 in _1.editNodeProperties){_3[_4]=_1.editNodeProperties[_4]}}
...
,isc.A.addComponent=function(_1){this.logInfo("EditPane adding component: "+this.echoLeaf(_1),"editing");if(this.editComponents==null)this.editComponents=[];this.editComponents.add(_1);var _2=_1.liveObject;this.addChild(_2);if(this.creator.editingOn)this.enableEditing(_1);if(_1.useEditMask)_1.showEditMask()}
...
var _5=(isc.isAn.Array(_1)?_1[0]:_1);_5.dropped=true;this.logInfo("sourceWidget is a Palette, dropped node of type: "+_5.type," editing");var _6=this;this.requestLiveObject(_5,function(_7){if(_7==null)return;if(_4==_6)_6.removeComponent(_5,_2,_3);_6.addNode(_7,_2,_3)},_4)}
...
,isc.A.serializeEditNodes=function(_1,_2){var _3=isc.SB.create();this.serverless=_2;for(var i=0;i<_1.length;i++){var _5=_1[i]=isc.addProperties({},_1[i]),_6=isc.ClassFactory.getClass(_5.type),_7=_5.initData=isc.addProperties({},_5.initData);if(_6&&_6.isA("Canvas")&&_7&&_7.visibility!=isc.Canvas.HIDDEN)
{_7.autoDraw=true}}
...
addGlobalId:"false",
fields:{
name:{basic:"true",primaryKey:"true",required:"true",title:"Name",type:"string",
xmlAttribute:"true"},
type:{basic:"true",title:"Type",type:"string",xmlAttribute:"true"},
idAllowed:{title:"ID Allowed",type:"boolean",xmlAttribute:"true"},
...
canSave:{title:"Can Save",type:"boolean",xmlAttribute:"true"},
...
fields:{childTagName:"field",hidden:"true",multiple:"true",propertiesOnly:"true",
type:"DataSourceField",uniqueProperty:"name"},
...
fields:{
inheritsFrom:{name:"inheritsFrom",type:"string"},
editorType:{name:"editorType",type:"string"}
}
})
isc.DataSource.create({Constructor:"XSComplexType",ID:"XSComplexType",addGlobalId:false,inheritsFrom:"DataSource"})
isc.DataSource.create({Constructor:"XSElement",ID:"XSElement",addGlobalId:false,inheritsFrom:"DataSource"})
isc.DataSource.create({
Constructor:"SchemaSet",
ID:"SchemaSet",
addGlobalId:false,
fields:{
schemaNamespace:{name:"schemaNamespace",type:"url"},
schemaImports:{multiple:true,name:"schemaImports",type:"Object"},
qualifyAll:{name:"qualifyAll",type:"boolean"},
schema:{multiple:true,name:"schema",type:"DataSource"}
}
})
isc.DataSource.create({Constructor:"WSDLMessage",ID:"WSDLMessage",addGlobalId:false,inheritsFrom:"DataSource"})
isc.DataSource.create({
Constructor:"WebService",
ID:"WebService",
addGlobalId:false,
fields:{
location:{name:"location",type:"url"},
targetNamespace:{name:"targetNamespace",type:"url"},
schemaImports:{multiple:true,name:"schemaImports",type:"Object"},
wsdlImports:{multiple:true,name:"wsdlImports",type:"Object"},
operations:{multiple:true,name:"operations",type:"WebServiceOperation"},
portTypes:{multiple:true,name:"portTypes",type:"Object"},
bindings:{multiple:true,name:"bindings",type:"Object"},
messages:{multiple:true,name:"messages",type:"WSDLMessage"},
globalNamespaces:{name:"globalNamespaces",type:"Object"}
}
})
isc.DataSource.create({
...
addGlobalId:false,
fields:{
name:{name:"name",required:true,title:"Operation Name"},
soapAction:{name:"soapAction",title:"SOAPAction Header"},
inputMessage:{name:"inputMessage",title:"Input Message"},
outputMessage:{name:"outputMessage",title:"Output Message"},
inputHeaders:{multiple:true,name:"inputHeaders",type:"WSOperationHeader"},
outputHeaders:{multiple:true,name:"outputHeaders",type:"WSOperationHeader"}
}
})
isc.DataSource.create({
...
if(_2=="bracket"){if(this.showTopRemoveButton){var _6=this.removeButton=this.createAutoChild("removeButton",{click:function(){this.creator.parentClause.removeButtonClick(this.creator)}});this.clauseLayout=this;this.addMember(_6)}
...
,isc.A.addNewClause=function(_1){var _2=isc.clone(this.filterRow);var _3=this.getDataSource().getFieldNames(true);var _4={};for(var i=0;i<_3.length;i++){var _6=_3[i];var _7=this.getDataSource().getField(_6);if(_7.canFilter==false)continue;if(this.showFieldTitles){var _8=_7.title;_8=_8?_8:_6;_4[_6]=_8}else{_4[_6]=_6}}
_2[0].valueMap=_4;if(_1&&_1.fieldName){if(_3.contains(_1.fieldName)){_2[0].defaultValue=_1.fieldName}else{isc.logWarn("Criterion specified field "+_1.fieldName+", which is not"+" in the record. Using the first record field ("+_3[0]+") instead");_2[0].defaultValue=_3[0]}}else{_2[0].defaultValue=_3[0]}
var _9=this.getDataSource().getFieldOperatorMap(_3[0],false,"criteria",true);_2[1].valueMap=_9;if(_1&&_1.operator){_2[1].defaultValue=_1.operator}else{_2[1].defaultValue=isc.firstKey(_9)}
var _10=this.getDataSource().getSearchOperator(_2[1].defaultValue),_7=this.getDataSource().getField(_2[0].defaultValue);if(!_10){isc.logWarn("Criterion specified unknown operator "+_1.operator+". Using the first valid operator ("+isc.firstKey(_9)+") instead");_2[1].defaultValue=isc.firstKey(_9);_10=this.getDataSource().getSearchOperator(_2[1].defaultValue)}
var _11=this.buildValueItemList(_7,_10);if(_1){if(_1.value!=null&&_11.containsProperty("name","value")){_11.find("name","value").defaultValue=_1.value}
if(_1.start!=null&&_11.containsProperty("name","start")){_11.find("name","start").defaultValue=_1.start}
if(_1.end!=null&&_11.containsProperty("name","end")){_11.find("name","end").defaultValue=_1.end}}
_2.addList(_11);var _12=this.createAutoChild("clause",{flattenItems:true,items:_2});this.clauses.add(_12);var _13=this.createAutoChild("removeButton");var _14=[_13];_14.add(_12);var _15=this.createAutoChild("clauseLayout",{visibility:"hidden",members:_14});_12.removeButton=_13;_12.clauseLayout=_15;_13.clause=_12;var _16=this.clauseStack;var _17=Math.max(0,_16.getMemberNumber(this.buttonBar));_16.addMember(_15,_17);_16.showMember(_15,function(){_12.focusInItem("fieldName")});this.updateFirstRemoveButton()}
,isc.A.buildValueItemList=function(_1,_2){if(_2==null){this.logWarn("buildValueItemList passed null operator")}
var _3=_1.name,_4=_2?_2.valueType:"text",_5=isc.SimpleType.getType(_1.type)||isc.SimpleType.getType("text"),_6=[];while(_5.inheritsFrom){_5=isc.SimpleType.getType(_5.inheritsFrom)}
...
var _8=isc.addProperties({type:_5,name:_1.name,showTitle:false,width:150,editorType:_7,changed:function(){this.form.creator.valueChanged(this,this.form)}},this.getValueFieldProperties(_1.type,_3));_8=this.getDataSource().combineFieldData(_8);_8.name="value";if(_1.type=="enum"){_8=isc.addProperties(_8,{valueMap:_1.valueMap})}
if(_5=="boolean"){_8=isc.addProperties(_8,{defaultValue:false})}
_6.add(_8)}else if(_4=="fieldName"){var _9=this.getDataSource().getFieldNames(true);_9.remove(_3);var _10={};for(var i=0;i<_9.length;i++){_3=_9[i];if(this.showFieldTitles){var _12=this.getDataSource().getField(_3).title;_12=_12?_12:_3;_10[_3]=_12}else{_10[_3]=_3}}
_6.add(isc.addProperties({type:"select",name:"value",showTitle:false,width:150,valueMap:_10,changed:function(){this.form.creator.valueChanged(this,this.form)}},this.getValueFieldProperties(_1.type,_3)))}else if(_4=="valueRange"){_6.addList([isc.addProperties({type:_5,name:"start",showTitle:false,width:150,changed:function(){this.form.creator.valueChanged(this,this.form)}},this.getValueFieldProperties(_1.type,_3)),isc.addProperties({type:"staticText",name:"rangeSeparator",showTitle:false,width:1,defaultValue:this.rangeSeparator,shouldSaveValue:false,changed:function(){this.form.creator.valueChanged(this,this.form)}},this.getValueFieldProperties(_1.type,_3)),isc.addProperties({type:_5,name:"end",showTitle:false,width:150,changed:function(){this.form.creator.valueChanged(this,this.form)}},this.getValueFieldProperties(_1.type,_3))])}
if(this.validateOnChange){for(var i=0;i<_6.length;i++){isc.addProperties(_6[i],{blur:function(_13,_14){if(!_13.creator.itemsInError)_13.creator.itemsInError=[];if(!_13.validate(null,null,true)){_14.focusInItem();if(!_13.creator.itemsInError.contains(_14)){_13.creator.itemsInError.add(_14)}}else{if(!_13.creator.itemsInError.contains(_14)){_13.creator.itemsInError.remove(_14)}}}})}}
return _6}
...
_1.addItems(_5)}
,isc.A.updateFields=function(_1){var _2=_1.getValue("fieldName");if(_2==null)return;var _3=this.getDataSource().getField(_2);var _4=_1.getValue("operator");_1.getItem("operator").setValueMap(this.getDataSource().getFieldOperatorMap(_3,false,"criteria",true));if(_4==null||_1.getValue("operator")!=_4){if(_1.getValue("operator")==null){_1.getItem("operator").setValue(_1.getItem("operator").getFirstOptionValue())}
_4=_1.getValue("operator")}
_4=this.getDataSource().getSearchOperator(_4);var _5;if(_1.getItem("value")){var _6=_1.getItem("value").type,_7=_3.type||"text";_5=(_6!=_7)}
this.removeValueFields(_1);_1.addItems(this.buildValueItemList(_3,_4));if(_5)_1.clearValue("value");else{var _8=_1.getItem("value");if(_8&&_8.getValueMap()&&_8.$193&&!_8.$193(_8.getValue()))
{_8.clearValue()}}
if(_1.getItem("start"))_1.setValue("start",null);if(_1.getItem("end"))_1.setValue("end",null)}
...
);isc.B._maxIndex=isc.C+27;isc.FilterBuilder.registerStringMethods({search:"criteria",filterChanged:""})}
