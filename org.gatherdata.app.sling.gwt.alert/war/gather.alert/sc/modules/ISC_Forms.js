...
_4.append("<\/TR><\/TABLE>")}
_4.append("<TABLE WIDTH=100% HEIGHT=",(this.getHeight()-this.headerHeight)," CELLSPACING=0 CELLPADDING=2 BORDER=",this.cellBorder,">");_4.append("<TR><TR HEIGHT=15>");var _10=this.getDayNames();var _11=Date.getWeekendDays();for(var i=0;i<_10.length;i++){var _13=_11.contains((i+this.firstDayOfWeek)%7)
...
if(this.showTodayButton||this.showCancelButton){_4.append("<TR");if(this.todayButtonHeight!=null)_4.append(" HEIGHT=",this.todayButtonHeight);_4.append(">");if(this.showTodayButton){var _20=!this.showCancelButton?(this.showWeekends?7:5):(!this.showWeekends?3:4);_4.append(this.getCellButtonHTML(this.todayButtonTitle,this.getID()+".todayClick()",this.baseBottomButtonStyle||this.baseButtonStyle,null,null,isc.Canvas.CENTER," COLSPAN="+_20))}
if(this.showCancelButton){var _20=!this.showTodayButton?(this.showWeekends?7:5):(!this.showWeekends?2:4);_4.append(this.getCellButtonHTML(this.cancelButtonTitle,this.getID()+".cancelClick()",this.baseBottomButtonStyle||this.baseButtonStyle,null,null,isc.Canvas.CENTER," COLSPAN="+_20))}
_4.append("<\/TR>")}
...
,isc.A.setMinValue=function(_1){this.minValue=_1;this.$50.setContents(_1);this.setValue(this.minValue)}
,isc.A.setMaxValue=function(_1){this.maxValue=_1;this.$52.setContents(_1);this.setValue(this.minValue)}
,isc.A.setNumValues=function(_1){this.numValues=_1;this.$8z=this.$8y/(this.numValues-1);this.setValue(this.minValue)}
);isc.B._maxIndex=isc.C+22;isc.Slider.registerStringMethods({valueChanged:"value"})
...
return false}
,isc.A.addItems=function(_1,_2){if(!isc.isAn.Array(_1))_1=[_1];if(this.dataSource){var _3=isc.DS.get(this.dataSource);for(var i=0;i<_1.length;i++){_1[i]=this.combineFieldData(_1[i])}}
...
,isc.A.getValuesAsCriteria=function(_1){var _2=this.$657();var _3=this.getFields();var _4=false;for(var i=0;i<_3.length;i++){if(_3[i].operator){_4=true;break}}
var _6=this.dataSource;if(!_6){if(this.grid&&this.grid.sourceWidget)_6=this.grid.sourceWidget.dataSource}
_6=isc.DataSource.getDataSource(_6);if(!_4||!_6){if(_1)return _2;return isc.DataSource.filterCriteriaForFormValues(_2)}
var _7={_constructor:"AdvancedCriteria",operator:this.operator}
var _8=[];for(i=0;i<_3.length;i++){var _9=_3[i];var _10=_3[i].criteriaField?_3[i].criteriaField:_3[i].name;if(_6.getField(_10)==null)continue
var _11=_9.getCriterion();if(_11)_8.add(_11)}
_7.criteria=_8;return _7}
,isc.A.$657=function(){var _1={};var _2=this.getFields();for(var i=0;i<_2.length;i++){var _4=_2[i].getCriteriaFieldName();if(_4)_1[_4]=_2[i].getCriteriaValue()}
return _1}
...
,isc.A.redraw=function(){this.$107();if(isc.Browser.isMoz)this.$106();this.Super("redraw",arguments);this.$108();this.setItemValues(null,true);var _1,_2,_3;if(isc.Browser.isMoz){_3=this.getClipHandle();if(_3){_1=_3.scrollLeft;_2=_3.scrollTop}}
...
return _1}
,isc.A.setItemValues=function(_1,_2,_3,_4){var _5=(_1==null);if(_5)_1=this.getValues();if(_1==null)_1={};_4=_4||this.items;for(var _6=0;_6<_4.length;_6++){var _7=_4[_6],_8=_7.getFieldName(),_9=_7.getDataPath(),_10=_7.isSetToDefaultValue(),_11;if(_9){var _12=_9.split("/"),_13=_1;for(var i=0;i<_12.length-1;i++){_13=_13[_12[i]];if(_13==null)break}
...
);isc.evalBoundary;isc.B.push(isc.A.getTableStartHTML=function(){var _1=isc.isA.DynamicForm(this)?this.$10g:isc.DynamicForm.getPrototype().$10g;_1[1]=this.$11n();_1[4]=(this.getInnerContentWidth!=null?this.getInnerContentWidth():this.getInnerWidth());_1[6]=this.cellSpacing;_1[8]=this.cellPadding;_1[10]=this.cellBorder;return _1.join(isc.emptyString)}
...
,isc.A.validate=function(_1,_2,_3,_4){if(this.disableValidation)return true;if(this.dataSource&&this.dataSource.useLocalValidators!=null&&this.useLocalValidators==false)return true;var _5=this.hasErrors(),_6=false,_7=null,_8=this.getForm(),_9=false;var _10={},_11={},_12=this.getValues(),_13=(_1&&!_2&&this.dataSource)?isc.addProperties({},this.getDataSource().getFields()):null;for(var _14=0;_14<this.items.length;_14++){var _15=false,_16=this.items[_14],_17=_16.getFieldName(),_18=_16.getValue(),_19=!_16.visible||isc.isA.HiddenItem(_16);if(_19&&!_1)continue;if(_16.validators!=null){if(!isc.isAn.Array(_16.validators)){_16.validators=[_16.validators]}
var _20=_16.validators;this.logDebug("Applying "+_20.length+" validators to field '"+_17+"' with value '"+_18+"'");for(var v=0;v<_20.length;v++){var _22=_20[v];if(!_22)continue;if(_3&&!this.$685.contains(_22.type)){continue}
var _23=this.processValidator(_16,_22,_18);if(_23!=true){var _24=isc.Validator.getErrorMessage(_22);if(_24==null)_24=this.unknownErrorMessage;_15=this.addValidationError(_10,_17,_24);if(_15)_6=true}
if(_22.resultingValue!=null){_18=_12[_17]=_22.resultingValue;_9=true}
if(!_23&&_22.stopIfFalse)break}}
if(_16.required&&!_10[_17]&&!_3){if(_18==null||isc.is.emptyString(_18)){_15=this.addValidationError(_10,_17,isc.Validator.requiredField);if(_15)_6=true}}
if(_19){if(_15)_11[_17]=_10[_17]}else if(_7==null&&_6)_7=_16;if(_13)delete _13[_17]}
if(_13){for(var i in _13){var _26=_13[i],_27=i,_20=_26.validators,_28=_26.required,_18=_12[_27];if(_28&&_18==null){this.addValidationError(_10,_27,isc.Validator.requiredField)}else if(_20!=null){var _18=_12[_27];for(var i=0;i<_20.length;i++){var _22=_20[i];if(!_22)continue;if(_22.type!="requiredIf"&&_18==null){continue}
if(!this.processValidator(_26,_22,_18)){var _24=_22.errorMessage||this.unknownErrorMessage;this.addValidationError(_10,_27,_24)}}}
if(_10[_27]!=null)_11[_27]=_10[_27]}}
if(_6)this.logInfo("Validation errors: "+isc.Log.echoAll(_10));if(_4)return(_6?_10:true);this.setErrors(_10);if(_9){this.setItemValues(_12);for(var _29 in _12){if(this.getItem(_29)==null)this.$10w(_29,_12[_29])}}
...
,isc.A.handleClick=function(_1,_2){var _3=this.$ne(_1);if(this.editingOn){if(!_3||!_3.item||(!_3.inactiveContext&&!_3.overTitle&&!_3.overIcon&&!_3.overElement&&!_3.overTextBox&&!_3.overControlTable)){return this.Super("handleClick",arguments)}}
if(_3&&_3.item){var _4=_3.item;if(_3.inactiveContext){return this.bubbleInactiveEditorEvent("click",_4,_3)}
else{if(_3.overTitle){return this.bubbleItemHandler(_4,"handleTitleClick",_4)}
else{var _5=(_3.overElement||_3.overTextBox||_3.overControlTable);if(_3.overIcon){if(_4.$116(_3.overIcon)==false)
return false;var _6=_4.$117(_3.overIcon);if(_6&&_6.writeIntoItem)
_5=true}
...
return _9}
,isc.A.getNearestItem=function(_1,_2){var _3=9999999999,_4;this.logDebug("Computing nearest item to ("+_1+","+_2+")","formItemDragDrop");for(var i=0;i<this.items.length;i++){var _6=this.items[i];var _7=_6.getPageRect(true),_8=_7[0],_9=_7[1],_10=_7[2],_11=_7[3],_12=0,_13=0;if(_1>=_8&&_1<=_8+_10&&_1>=_9&&_1<=_9+_11)
{return _6}
...
if(_3<=_6)_3=_6+1;else if(_3>=_6+_8)_3=_6+_8-1;var _11=_2-_5,_12=Math.round(_7/ _11),_13=_3-_6,_14=Math.round(_8/ _13),_15=(_5+_7)-_2,_16=Math.round(_7/ _15),_17=(_6+_8)-_3,_18=Math.round(_8/ _17),_19="R",_20,_21,_22,_23;_5--;_6--;if(_10||Math.min(_12,_16)<Math.min(_14,_18)){_19=_10?"R":_12>_16?"L":"R";_21=3;_20=_8;_22=_19=="L"?_5:_5+_7-1;_23=_6}else{_19=_14>_18?"T":"B";_21=_7;_22=_5;_20=3;_23=_19=="T"?_6:_6+_8-1}
_1.dropSide=_19;if(this.itemIsLastInRow(_1,_1.$69f)&&!this.canAddColumns&&_1.dropSide=="R"){this.hideDragLine();this.setNoDropIndicator();this.$69h=this.currentCursor;this.setCursor("not-allowed")}
else{if(this.$uh){this.clearNoDropIndicator()
this.setCursor(this.$69h)}
var _24={left:_22,top:_23};this.adjustDragLinePosition(_24,_1,_19);_22=_24.left;_23=_24.top;this._dragLine.resizeTo(_21,_20);this._dragLine.setPageRect(_22,_23);this._dragLine.bringToFront();this._dragLine.show()}}
...
);isc.B._maxIndex=isc.C+209;isc.A=isc.DynamicForm;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.defaultFieldType="text";isc.A.$12a="link";isc.A.$gx="text";isc.A.$12b="select";isc.A.$12c="checkbox";isc.A.$12d="staticText";isc.A.$g2="boolean";isc.A.$12e="binary";isc.A.$12f="blob";isc.A.$52w="multifile";isc.A.$12g="multiupload";isc.A.$9i="upload";isc.A.$52x="file";isc.A.$51x="base64Binary";isc.A.$12h="enum";isc.A.$12i="CycleItem";isc.A.$12j="selectOther";isc.A.$12k="relation";isc.A.$67f="NestedEditorItem";isc.A.$67g="NestedListEditorItem";isc.A.$677="imageFile";isc.A.$678="ViewFileItem";isc.A.$450="id";isc.B.push(isc.A.getEditorType=function(_1,_2){if(_1._constructor==isc.FormItem.Class)_1._constructor=null;var _3=_2.getDataSource();var _4=this.defaultFieldType,_5=_1.editorType||_1.formItemType||_1._constructor||_1.type||_4;if(_1.editorType||_1.formItemType||_1._constructor)return _5;if(_5==this.$12a){if(!this.canEditField(_1,_2))_5=this.$12a;else _5=this.$gx}else if(!this.canEditField(_1,_2)){if(_5==this.$12e||_5==this.$52x||_5==this.$677)
...
else _5=this.$12b}else if(_3&&_3.fieldIsComplexType(_1.name)){_5=_1.multiple?_2.nestedListEditorType:_2.nestedEditorType}else{if(!_1.type||(_1.type==_4)||(_1.type!=this.$12j&&(isc.FormItemFactory.getItemClass(_1.type)==null)))
...
return _5}
,isc.A.canEditField=function(_1,_2){if(_1.canEdit!=null)return _1.canEdit;if(_1.canSave==false&&(!_2||!_2.$66m)){return false}
return true}
...
);isc.evalBoundary;isc.B.push(isc.A.$516=function(){this.$105=true;this.rememberSelection();if(this.items){for(var i=0;i<this.items.length;i++){if(this.items[i].hasFocus){return this.items[i].$516()}}}
...
return isc.Time.toTime(_1,this.timeFormatter);if(this.$64&&this.applyCustomTypeFormat){return this.$62.normalDisplayFormatter(_1,this,this.form,this.form.values)}
...
);isc.evalBoundary;isc.B.push(isc.A.$65v=function(){return(this.rejectInvalidValueOnChange!=null)?this.rejectInvalidValueOnChange:this.form.rejectInvalidValueOnChange}
...
,isc.A.$17y=function(){}
,isc.A.$171=function(){}
,isc.A.$wb=function(_1){if(this.itemHover&&this.itemHover(this,this.form)==false)return false;var _2;if(this.itemHoverHTML)_2=this.itemHoverHTML();else _2=this.form.itemHoverHTML(this,this.form);this.form.$119(this,_2)}
,isc.A.$17x=function(_1){if(this.titleHover&&this.titleHover(this,this.form)==false)return false;var _2;if(this.titleHoverHTML)_2=this.titleHoverHTML();else _2=this.form.titleHoverHTML(this,this.form);this.form.$119(this,_2)}
...
return false},integerRange:function(_1,_2,_3){var _4=_3;if(!isc.isA.String(_3))_3=parseInt(_3,10);if(isNaN(_3)||_3!=_4)return true;_2.dynamicErrorMessageArguments={validator:_2,max:_2.max,min:_2.min}
...
return true}},isUnique:function(_1,_2,_3){if(_2.serverOnly!==false)return true},isUnique:function(_1,_2,_3){if(_2.serverOnly!==false)return true},serverCustom:function(_1,_2,_3){if(_2.serverOnly!==false)return true}};isc.A=isc.Validator;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.processValidator=function(_1,_2,_3,_4){if(_2.serverOnly)return true;if(!_4)_4=_2.type;var _5=true;var _6;if(_4!=null)_6=this.$18s[_4];if(_6==null&&_2.condition){if(!isc.isA.Function(_2.condition)){this.logDebug("Creating function for validation condition:\r"+_2.condition);isc.Func.replaceWithMethod(_2,"condition","item,validator,value")}
_6=_2.condition}
...
if(this.mask){var _5=this.$714(this.getValue());this.setElementValue(_5)}
...
return _3}
,isc.A.setKeyPressFilter=function(_1){this.keyPressFilter=_1;this.$66y=null;if(this.keyPressFilter){this.$66y=new RegExp(this.keyPressFilter)}}
,isc.A.init=function(){this.Super("init",arguments);if(this.mask){this.$72b()}else if(this.keyPressFilter){this.$66y=new RegExp(this.keyPressFilter)}}
...
{return true}
if(this.mask){var _5=this.$72c();var _6=isc.Browser.isSafari;if((_5.begin-_5.end)!=0||(_6&&this.$72d))
{if(_3=="Backspace"||_3=="Delete"||this.$660(_4))
{if(isc.Browser.isSafari&&this.$72d){_5=this.$72d;this.$72d=null}
this.$72e(_5.begin,_5.end)}else if(_6){if((_5.begin-_5.end)!=0){this.$72d=_5}else{this.$72d=null}}}
var _7=_5.begin;if(_3=="Backspace"){this.$72f((_6&&_5.begin==_5.end)?_7:_7-1);return false}else if(_3=="Delete"){this.$72f(_7);return false}
...
{return true}
var c=String.fromCharCode(_4);if(this.mask){var p=this.$72h(_7-1);if(p<this.$718){var _10=this.$72i[p];if(_10){if(_10.casing){c=this.$72j(c,_10.casing)}
if(_10.filter.test(c)){this.$72k(p);this.$72l[p]=c;this.$717(true);var _11=this.$72h(p);this.$72a(_11)}}}
return false}
var _12=c;if(!this.mask)_12=this.$72j(c,this.characterCasing);if(c==_12&&!this.$66y)return true;if(this.$66y){if(this.$660(_4)&&!this.$66y.test(_12)){return false}}
if(c==_12)return true;var _13=this.getValue()||"";var _5=this.getSelectionRange();if((_5[0]-_5[1])!=0){_13=_13.substring(0,_5[0])+_12+_13.substring(_5[1]+1)}else{_13=_13.substring(0,_5[0])+_12+_13.substring(_5[1])}
this.setValue(_13);this.setSelectionRange(_5[0]+1,_5[0]+1);return false}
...
return _1}
,isc.A.$716=function(_1){if(_1==null)_1="";var _2=false;var _3=-1;var _4="";for(var i=0,_6=0;i<_1.length;i++){var c=_1.charAt(i);if(this.$72i[i]){if(c!=this.maskPromptChar&&this.$72i[i].filter.test(c)){_4+=c;_2=true;_3=i}else{_4+=this.maskPadChar}}else if(this.maskSaveLiterals){_4+=c;_3=i}}
...
if(!this.pickList){var _5=this.pickListProperties;this.pickList=isc.PickListMenu.create({headerHeight:this.pickListHeaderHeight},_5);var _6=this.pickList.dataProperties||{};if(this.filterLocally)_6.fetchMode="local";this.pickList.dataProperties=_6;if(_4)this.storeSharedPickList()}
...
if(_2[_7]==null)return _6.emptyCellValue;return _1},getPickListFilterCriteria:function(){var _1=this.optionCriteria||{};return isc.addProperties(_1,this.pickListCriteria)},getAllLocalOptions:function(){return this.$19m()?null:this.getClientPickListData()},$19o:function(_1,_2){var _3=this.getOptionDataSource();if(_3==null){return}
...
this.$19v();var _7=(_3&&_3.clientContext?_3.clientContext.$03:null);if(_7)this.fireCallback(_7,"item,dsResponse",[this,_1])},$19v:function(){if(this.isDrawn()&&this.getValueFieldName()!=null&&this.$19m())
...
);isc.B._maxIndex=isc.C+50;isc.ClassFactory.mixInInterface("SelectItem","PickList");isc.SelectItem.registerStringMethods({dataArrived:"startRow,endRow,data",getPickListFilterCriteria:""})}
...
,isc.A.init=function(_1,_2,_3,_4){if(this.titleStyle!=null&&!this.showTitle)this.textBoxStyle=this.titleStyle;this.invokeSuper(isc.CheckboxItem,"init",_1,_2,_3,_4);if(this.showValueIconOnly==null)this.showValueIconOnly=!this.showLabel;if(this.textAlign==null&&this.align!=null){this.textAlign=this.align}}
...
var _6={type:"radio",name:"$540"+_2,value:_2,getElementName:function(){return this.parentItem.getElementName()},title:_1,prompt:_4,height:this.itemHeight,$8l:this.vertical,titleStyle:this.titleStyle,updateValue:function(){this.parentItem.updatePreviousSelection(this.value);return this.Super("updateValue",arguments)},shouldSaveValue:false};_3=this.itemCache[_2+"|"+_1]=isc.FormItemFactory.makeItem(_6)}
return _3}
...
_1.add(_4);var _5;this.daySelector=this.yearSelector=this.monthSelector=_5}else{for(var i=0;i<_3.length;i++){var _7=_3.charAt(i);var _8,_9,_10;if(_7=="D"){var _8;if(this.daySelectorProperties!=null){_8=isc.addProperties({},_2.DAY_SELECTOR,this.daySelectorProperties)}else{_8=isc.addProperties({},_2.DAY_SELECTOR)}
...
return this.targetItem.form.getSaveOperationType();return this.Super("getSaveOperationType",arguments)},items:[{targetItem:this,type:"upload",name:this.getFieldName(),showTitle:false,saveValue:function(_1,_2,_3,_4){this.Super("saveValue",arguments);this.targetItem.saveValue(_1,_2,_3,_4)}},{name:"_transaction",type:"HiddenItem"}]});this.containerWidget.addChild(this.canvas)}
...
,isc.A.sliderChange=function(){var _1=this.canvas.getValue();if(this.$207!=_1){this.$10y(_1);this.$207=_1}else{this.saveValue(_1)}}
...
,isc.A.showFieldErrors=function(_1){var _2=this.getMemberForField(_1);if(!isc.isA.DynamicForm(_2))return;if(_2&&_2.isVisible()&&_2.isDrawn()){var _3=_2.getItem(_1);if(_3&&_3.visible){_3.redraw("Validation errors modified");return}}
this.$21z()}
...
,isc.A.$708=function(_1,_2,_3){for(var _4 in _2){if(!isc.isA.Function(_2[_4])){var _5=_4;if(_3){_5=_3+_4}else{_5=_4}
var _6=this.getItem(_5);if(_6&&_6.isSetToDefaultValue()){this.$10t.add(_5)}
var _7=_2[_4];if(isc.isA.Date(_7)){_1[_4]=new Date();_1[_4].setTime(_7.getTime())}else if(isc.isAn.Object(_7)&&!isc.isAn.Array(_7)){_1[_4]={};this.$708(_1[_4],_7,(_5+isc.Canvas.$70l))}else{_1[_4]=_2[_4]}}}}
