...
schemaImports:[
{location:"",namespace:"urn:partner.soap.sforce.com"}
],
schema:[
...
serviceNamespace:"urn:partner.soap.sforce.com",
schemaImports:[
{location:"",namespace:"urn:sobject.partner.soap.sforce.com"}
],
schema:[
...
mustQualify:true,
fields:{
result:{name:"result",nillable:"true",type:"DescribeSObjectResult",xmlRequired:true}
}
})
,
isc.XSElement.create({
...
mustQualify:true,
fields:{
sObjectType:{name:"sObjectType",type:"string",xmlRequired:false}
}
})
,
isc.XSElement.create({
...
mustQualify:true,
fields:{
result:{name:"result",nillable:"true",type:"DescribeSObjectResult",xmlRequired:false}
}
})
,
isc.XSElement.create({
...
fields:{
sObjectType:{name:"sObjectType",type:"string",xmlRequired:true},
recordTypeIds:{name:"recordTypeIds",type:"ID",xmlRequired:false}
}
})
,
isc.XSElement.create({
...
mustQualify:true,
fields:{
result:{name:"result",nillable:"true",type:"DescribeLayoutResult",xmlRequired:true}
}
})
,
isc.XSElement.create({
...
mustQualify:true,
fields:{
result:{name:"result",nillable:"true",type:"DescribeSoftphoneLayoutResult",xmlRequired:true}
}
})
,
isc.XSElement.create({
...
mustQualify:true,
fields:{
result:{name:"result",nillable:"true",type:"DescribeTabSetResult",xmlRequired:false}
}
})
,
isc.XSElement.create({
...
mustQualify:true,
fields:{
sObjects:{name:"sObjects",type:"sObject",xmlRequired:false}
}
})
,
isc.XSElement.create({
...
mustQualify:true,
fields:{
result:{name:"result",type:"SaveResult",xmlRequired:false}
}
})
,
isc.XSElement.create({
...
mustQualify:true,
fields:{
externalIDFieldName:{name:"externalIDFieldName",type:"string",xmlRequired:true},
sObjects:{name:"sObjects",type:"sObject",xmlRequired:false}
}
})
,
...
mustQualify:true,
fields:{
result:{name:"result",type:"UpsertResult",xmlRequired:false}
}
})
,
isc.XSElement.create({
...
mustQualify:true,
fields:{
request:{name:"request",type:"MergeRequest",xmlRequired:false}
}
})
,
isc.XSElement.create({
...
mustQualify:true,
fields:{
result:{name:"result",type:"MergeResult",xmlRequired:false}
}
})
,
isc.XSElement.create({
...
mustQualify:true,
fields:{
result:{name:"result",type:"DeleteResult",xmlRequired:false}
}
})
,
isc.XSElement.create({
...
mustQualify:true,
fields:{
result:{name:"result",type:"UndeleteResult",xmlRequired:true}
}
})
,
isc.XSElement.create({
...
mustQualify:true,
fields:{
actions:{name:"actions",type:"ProcessRequest",xmlRequired:false}
}
})
,
isc.XSElement.create({
...
mustQualify:true,
fields:{
result:{name:"result",type:"ProcessResult",xmlRequired:false}
}
})
,
isc.XSElement.create({
...
mustQualify:true,
fields:{
leadConverts:{name:"leadConverts",type:"LeadConvert",xmlRequired:false}
}
})
,
isc.XSElement.create({
...
mustQualify:true,
fields:{
result:{name:"result",type:"LeadConvertResult",xmlRequired:false}
}
})
,
isc.XSElement.create({
...
mustQualify:true,
fields:{
updateMru:{name:"updateMru",type:"boolean",xmlRequired:true}
}
})
,
isc.XSElement.create({
...
mustQualify:true,
fields:{
triggerAutoResponseEmail:{name:"triggerAutoResponseEmail",type:"boolean",xmlRequired:true},
triggerOtherEmail:{name:"triggerOtherEmail",type:"boolean",xmlRequired:true},
triggerUserEmail:{name:"triggerUserEmail",type:"boolean",xmlRequired:true}
}
})
,
isc.XSElement.create({
...
mustQualify:true,
fields:{
transferToUserId:{name:"transferToUserId",nillable:"true",type:"ID",xmlRequired:true}
}
})
,
...
,
isc.SimpleType.create({inheritsFrom:"string",name:"QueryLocator",xmlSource:"SimpleType"})
,
isc.XSComplexType.create({
ID:"QueryResult",
mustQualify:true,
...
fields:{
ids:{name:"ids",type:"ID",xmlRequired:false},
latestDateCovered:{name:"latestDateCovered",type:"dateTime",xmlRequired:true},
sforceReserved:{name:"sforceReserved",type:"string",xmlRequired:false}
}
})
,
...
earliestDateAvailable:{name:"earliestDateAvailable",type:"dateTime",xmlRequired:true},
latestDateCovered:{name:"latestDateCovered",type:"dateTime",xmlRequired:true},
sforceReserved:{name:"sforceReserved",type:"string",xmlRequired:false}
}
})
...
mustQualify:true,
fields:{
accessibilityMode:{name:"accessibilityMode",type:"boolean",xmlRequired:true},
currencySymbol:{name:"currencySymbol",nillable:"true",type:"string",xmlRequired:true},
licenseType:{name:"licenseType",type:"string",xmlRequired:true},
organizationId:{name:"organizationId",type:"ID",xmlRequired:true},
...
profileId:{name:"profileId",type:"ID",xmlRequired:true},
roleId:{name:"roleId",nillable:"true",type:"ID",xmlRequired:true},
...
userUiSkin:{name:"userUiSkin",type:"string",xmlRequired:true}
}
})
,
isc.XSComplexType.create({
...
userInfo:{name:"userInfo",type:"GetUserInfoResult",xmlRequired:false}
}
})
,
isc.SimpleType.create({
...
name:"StatusCode",
xmlSource:"SimpleType",
valueMap:["ALREADY_IN_PROCESS","ASSIGNEE_TYPE_REQUIRED","BAD_CUSTOM_ENTITY_PARENT_DOMAIN",
"CANNOT_CASCADE_PRODUCT_ACTIVE","CANNOT_CREATE_ANOTHER_MANAGED_PACKAGE","CANNOT_DEACTIVATE_DIVISION",
"CANNOT_DELETE_MANAGED_OBJECT","CANNOT_DISABLE_LAST_ADMIN","CANNOT_ENABLE_IP_RESTRICT_REQUESTS",
"CANNOT_INSERT_UPDATE_ACTIVATE_ENTITY","CANNOT_MODIFY_MANAGED_OBJECT","CANNOT_REPARENT_RECORD","CANNOT_RESOLVE_NAME",
"CANNOT_UPDATE_CONVERTED_LEAD","CANT_DISABLE_CORP_CURRENCY","CANT_UNSET_CORP_CURRENCY","CHILD_SHARE_FAILS_PARENT",
"CIRCULAR_DEPENDENCY","CUSTOM_CLOB_FIELD_LIMIT_EXCEEDED","CUSTOM_ENTITY_OR_FIELD_LIMIT",
"CUSTOM_FIELD_INDEX_LIMIT_EXCEEDED","CUSTOM_INDEX_EXISTS","CUSTOM_LINK_LIMIT_EXCEEDED","CUSTOM_TAB_LIMIT_EXCEEDED",
"DELETE_FAILED","DELETE_REQUIRED_ON_CASCADE","DEPENDENCY_EXISTS","DUPLICATE_CASE_SOLUTION",
"DUPLICATE_CUSTOM_ENTITY_DEFINITION","DUPLICATE_CUSTOM_TAB_MOTIF","DUPLICATE_DEVELOPER_NAME","DUPLICATE_EXTERNAL_ID",
"DUPLICATE_MASTER_LABEL","DUPLICATE_USERNAME","DUPLICATE_VALUE","EMPTY_SCONTROL_FILE_NAME",
"ENTITY_FAILED_IFLASTMODIFIED_ON_UPDATE","ENTITY_IS_ARCHIVED","ENTITY_IS_DELETED","ENTITY_IS_LOCKED","FAILED_ACTIVATION",
"FIELD_CUSTOM_VALIDATION_EXCEPTION","FIELD_INTEGRITY_EXCEPTION","IMAGE_TOO_LARGE","INACTIVE_OWNER_OR_USER",
"INSUFFICIENT_ACCESS_ON_CROSS_REFERENCE_ENTITY","INSUFFICIENT_ACCESS_OR_READONLY","INVALID_ACCESS_LEVEL","INVALID_ARGUMENT_TYPE",
"INVALID_ASSIGNEE_TYPE","INVALID_ASSIGNMENT_RULE","INVALID_BATCH_OPERATION","INVALID_CREDIT_CARD_INFO",
"INVALID_CROSS_REFERENCE_KEY","INVALID_CROSS_REFERENCE_TYPE_FOR_FIELD","INVALID_CURRENCY_CONV_RATE",
"INVALID_CURRENCY_ISO","INVALID_EMAIL_ADDRESS","INVALID_EMPTY_KEY_OWNER","INVALID_FIELD",
"INVALID_FIELD_FOR_INSERT_UPDATE","INVALID_FILTER_ACTION","INVALID_ID_FIELD","INVALID_INET_ADDRESS",
"INVALID_LINEITEM_CLONE_STATE","INVALID_MASTER_OR_TRANSLATED_SOLUTION","INVALID_OPERATION","INVALID_OPERATOR",
"INVALID_OR_NULL_FOR_RESTRICTED_PICKLIST","INVALID_PERSON_ACCOUNT_OPERATION","INVALID_STATUS","INVALID_TYPE",
"INVALID_TYPE_FOR_OPERATION","INVALID_TYPE_ON_FIELD_IN_RECORD","IP_RANGE_LIMIT_EXCEEDED",
"LAST_MODIFIED_SINCE_TOO_OLD","LICENSE_LIMIT_EXCEEDED","LIMIT_EXCEEDED","MALFORMED_ID","MANAGER_NOT_DEFINED",
"MAXIMUM_CCEMAILS_EXCEEDED","MAXIMUM_DASHBOARD_COMPONENTS_EXCEEDED","MAXIMUM_SIZE_OF_ATTACHMENT",
"MAXIMUM_SIZE_OF_DOCUMENT","MAX_ACTIONS_PER_RULE_EXCEEDED","MAX_ACTIVE_RULES_EXCEEDED",
"MAX_APPROVAL_STEPS_EXCEEDED","MAX_RULES_EXCEEDED","MAX_RULE_ENTRIES_EXCEEDED","MAX_TASK_DESCRIPTION_EXCEEEDED",
"MAX_TM_RULES_EXCEEDED","MAX_TM_RULE_ITEMS_EXCEEDED","MISSING_ARGUMENT","NONUNIQUE_SHIPPING_ADDRESS",
"NO_APPLICABLE_PROCESS","NUMBER_OUTSIDE_VALID_RANGE","NUM_HISTORY_FIELDS_BY_SOBJECT_EXCEEDED",
...
"TEXT_DATA_OUTSIDE_SUPPORTED_CHARSET","TOO_MANY_ENUM_VALUE","TRANSFER_REQUIRES_READ","UNAVAILABLE_RECORDTYPE_EXCEPTION",
"UNDELETE_FAILED","UNKNOWN_EXCEPTION","UNSPECIFIED_EMAIL_ADDRESS"]
})
,
isc.XSComplexType.create({
ID:"Error",
...
mustQualify:true,
fields:{
errors:{name:"errors",type:"Error",xmlRequired:false},
id:{name:"id",nillable:"true",type:"ID",xmlRequired:true},
...
mustQualify:true,
fields:{
created:{name:"created",type:"boolean",xmlRequired:true},
errors:{name:"errors",type:"Error",xmlRequired:false},
id:{name:"id",nillable:"true",type:"ID",xmlRequired:true},
success:{name:"success",type:"boolean",xmlRequired:true}
}
...
mustQualify:true,
fields:{
masterRecord:{name:"masterRecord",type:"sObject",xmlRequired:true},
recordToMergeIds:{name:"recordToMergeIds",type:"ID",xmlRequired:true}
}
})
,
isc.XSComplexType.create({
...
errors:{name:"errors",type:"Error",xmlRequired:false},
id:{name:"id",nillable:"true",type:"ID",xmlRequired:true},
mergedRecordIds:{name:"mergedRecordIds",type:"ID",xmlRequired:false},
success:{name:"success",type:"boolean",xmlRequired:true},
updatedRelatedIds:{name:"updatedRelatedIds",type:"ID",xmlRequired:false}
}
})
,
isc.XSComplexType.create({
...
mustQualify:true,
fields:{
comments:{name:"comments",nillable:"true",type:"string",xmlRequired:true},
nextApproverIds:{name:"nextApproverIds",nillable:"true",type:"ID",xmlRequired:false}
}
})
,
isc.XSComplexType.create({
...
fields:{
objectId:{name:"objectId",type:"ID",xmlRequired:true}
}
})
,
isc.XSComplexType.create({
...
useParentFieldOrder:true,
fields:{
action:{name:"action",type:"string",xmlRequired:true},
workitemId:{name:"workitemId",type:"ID",xmlRequired:true}
}
})
,
isc.XSComplexType.create({
...
mustQualify:true,
fields:{
entityId:{name:"entityId",nillable:"true",type:"ID",xmlRequired:true},
errors:{name:"errors",type:"Error",xmlRequired:false},
instanceId:{name:"instanceId",nillable:"true",type:"ID",xmlRequired:true},
instanceStatus:{name:"instanceStatus",nillable:"true",type:"string",xmlRequired:true},
newWorkitemIds:{name:"newWorkitemIds",nillable:"true",type:"ID",xmlRequired:false},
success:{name:"success",type:"boolean",xmlRequired:true}
}
})
,
...
mergeable:{name:"mergeable",type:"boolean",xmlRequired:true},
name:{name:"name",type:"string",xmlRequired:true},
queryable:{name:"queryable",type:"boolean",xmlRequired:true},
recordTypeInfos:{name:"recordTypeInfos",type:"RecordTypeInfo",xmlRequired:false},
...
relationshipName:{name:"relationshipName",type:"string",xmlRequired:false}
}
})
,
isc.XSComplexType.create({
...
"xsd:date","xsd:dateTime","xsd:anyType"]
})
,
isc.XSComplexType.create({
ID:"Field",
...
calculatedFormula:{name:"calculatedFormula",type:"string",xmlRequired:false},
caseSensitive:{name:"caseSensitive",type:"boolean",xmlRequired:true},
controllerName:{name:"controllerName",type:"string",xmlRequired:false},
createable:{name:"createable",type:"boolean",xmlRequired:true},
custom:{name:"custom",type:"boolean",xmlRequired:true},
defaultValueFormula:{name:"defaultValueFormula",type:"string",xmlRequired:false},
defaultedOnCreate:{name:"defaultedOnCreate",type:"boolean",xmlRequired:true},
dependentPicklist:{name:"dependentPicklist",type:"boolean",xmlRequired:false},
digits:{name:"digits",type:"int",xmlRequired:true},
externalId:{name:"externalId",type:"boolean",xmlRequired:false},
filterable:{name:"filterable",type:"boolean",xmlRequired:true},
htmlFormatted:{name:"htmlFormatted",type:"boolean",xmlRequired:false},
label:{name:"label",type:"string",xmlRequired:true},
length:{name:"length",type:"int",xmlRequired:true},
name:{name:"name",type:"string",xmlRequired:true},
nameField:{name:"nameField",type:"boolean",xmlRequired:true},
namePointing:{name:"namePointing",type:"boolean",xmlRequired:false},
...
sortable:{name:"sortable",type:"boolean",xmlRequired:false},
type:{name:"type",type:"fieldType",xmlRequired:true},
unique:{name:"unique",type:"boolean",xmlRequired:true},
updateable:{name:"updateable",type:"boolean",xmlRequired:true}
}
})
,
...
validFor:{name:"validFor",type:"base64Binary",xmlRequired:false},
...
mustQualify:true,
fields:{
callTypes:{name:"callTypes",type:"DescribeSoftphoneLayoutCallType",xmlRequired:true},
id:{name:"id",type:"ID",xmlRequired:true},
name:{name:"name",type:"string",xmlRequired:true}
}
})
...
mustQualify:true,
fields:{
infoFields:{name:"infoFields",type:"DescribeSoftphoneLayoutInfoField",xmlRequired:true},
name:{name:"name",type:"string",xmlRequired:true},
sections:{name:"sections",type:"DescribeSoftphoneLayoutSection",xmlRequired:false}
}
})
,
isc.XSComplexType.create({
...
mustQualify:true,
fields:{
entityApiName:{name:"entityApiName",type:"string",xmlRequired:true},
items:{name:"items",type:"DescribeSoftphoneLayoutItem",xmlRequired:true}
}
})
,
isc.XSComplexType.create({
...
mustQualify:true,
fields:{
itemApiName:{name:"itemApiName",type:"string",xmlRequired:true}
}
})
,
isc.XSComplexType.create({
...
recordTypeSelectorRequired:{name:"recordTypeSelectorRequired",type:"boolean",xmlRequired:true}
}
})
,
isc.XSComplexType.create({
...
id:{name:"id",type:"ID",xmlRequired:true},
relatedLists:{name:"relatedLists",type:"RelatedList",xmlRequired:false}
}
})
,
isc.XSComplexType.create({
...
mustQualify:true,
fields:{
displayLines:{name:"displayLines",type:"int",xmlRequired:true},
...
mustQualify:true,
fields:{
columns:{name:"columns",type:"RelatedListColumn",xmlRequired:true},
custom:{name:"custom",type:"boolean",xmlRequired:true},
field:{name:"field",nillable:"true",type:"string",xmlRequired:true},
label:{name:"label",type:"string",xmlRequired:true},
limitRows:{name:"limitRows",type:"int",xmlRequired:true},
name:{name:"name",type:"string",xmlRequired:true},
sobject:{name:"sobject",nillable:"true",type:"string",xmlRequired:true},
sort:{name:"sort",type:"RelatedListSort",xmlRequired:false}
}
})
,
isc.XSComplexType.create({
...
fields:{
field:{name:"field",nillable:"true",type:"string",xmlRequired:true},
format:{name:"format",nillable:"true",type:"string",xmlRequired:true},
label:{name:"label",type:"string",xmlRequired:true},
name:{name:"name",type:"string",xmlRequired:true}
}
})
...
mustQualify:true,
fields:{
ascending:{name:"ascending",type:"boolean",xmlRequired:true},
column:{name:"column",type:"string",xmlRequired:true}
}
})
,
isc.XSComplexType.create({
...
namespace:{name:"namespace",type:"string",xmlRequired:false},
...
name:"ExceptionCode",
xmlSource:"SimpleType",
valueMap:["API_CURRENTLY_DISABLED","API_DISABLED_FOR_ORG","CLIENT_NOT_ACCESSIBLE_FOR_USER",
"CLIENT_REQUIRE_UPDATE_FOR_USER","EMAIL_BATCH_SIZE_LIMIT_EXCEEDED","EMAIL_TO_CASE_INVALID_ROUTING",
"EMAIL_TO_CASE_LIMIT_EXCEEDED","EMAIL_TO_CASE_NOT_ENABLED","EXCEEDED_ID_LIMIT","EXCEEDED_LEAD_CONVERT_LIMIT",
"EXCEEDED_MAX_SIZE_REQUEST","EXCEEDED_MAX_TYPES_LIMIT","EXCEEDED_QUOTA","FUNCTIONALITY_NOT_ENABLED",
"INACTIVE_OWNER_OR_USER","INSUFFICIENT_ACCESS","INVALID_ASSIGNMENT_RULE","INVALID_BATCH_SIZE",
"INVALID_CLIENT","INVALID_CROSS_REFERENCE_KEY","INVALID_FIELD","INVALID_ID_FIELD","INVALID_LOCATOR",
...
"NOT_MODIFIED","NUMBER_OUTSIDE_VALID_RANGE","OPERATION_TOO_LARGE","ORG_LOCKED","PASSWORD_LOCKOUT",
"QUERY_TIMEOUT","QUERY_TOO_COMPLICATED","REQUEST_LIMIT_EXCEEDED","REQUEST_RUNNING_TOO_LONG",
...
"fns:CLIENT_NOT_ACCESSIBLE_FOR_USER","fns:CLIENT_REQUIRE_UPDATE_FOR_USER","fns:EMAIL_BATCH_SIZE_LIMIT_EXCEEDED",
"fns:EMAIL_TO_CASE_INVALID_ROUTING","fns:EMAIL_TO_CASE_LIMIT_EXCEEDED","fns:EMAIL_TO_CASE_NOT_ENABLED",
"fns:EXCEEDED_ID_LIMIT","fns:EXCEEDED_LEAD_CONVERT_LIMIT","fns:EXCEEDED_MAX_SIZE_REQUEST",
"fns:EXCEEDED_MAX_TYPES_LIMIT","fns:EXCEEDED_QUOTA","fns:FUNCTIONALITY_NOT_ENABLED","fns:INACTIVE_OWNER_OR_USER",
"fns:INSUFFICIENT_ACCESS","fns:INVALID_ASSIGNMENT_RULE","fns:INVALID_BATCH_SIZE","fns:INVALID_CLIENT",
"fns:INVALID_CROSS_REFERENCE_KEY","fns:INVALID_FIELD","fns:INVALID_ID_FIELD","fns:INVALID_LOCATOR",
"fns:INVALID_LOGIN","fns:INVALID_NEW_PASSWORD","fns:INVALID_OPERATION",
"fns:INVALID_OPERATION_WITH_EXPIRED_PASSWORD","fns:INVALID_QUERY_FILTER_OPERATOR","fns:INVALID_QUERY_LOCATOR",
"fns:INVALID_QUERY_SCOPE","fns:INVALID_REPLICATION_DATE","fns:INVALID_SEARCH","fns:INVALID_SEARCH_SCOPE",
"fns:INVALID_SESSION_ID","fns:INVALID_SOAP_HEADER","fns:INVALID_SSO_GATEWAY_URL","fns:INVALID_TYPE",
"fns:INVALID_TYPE_FOR_OPERATION","fns:LOGIN_DURING_RESTRICTED_DOMAIN","fns:LOGIN_DURING_RESTRICTED_TIME",
"fns:MALFORMED_ID","fns:MALFORMED_QUERY","fns:MALFORMED_SEARCH","fns:MISSING_ARGUMENT",
"fns:NOT_MODIFIED","fns:NUMBER_OUTSIDE_VALID_RANGE","fns:OPERATION_TOO_LARGE","fns:ORG_LOCKED",
"fns:PASSWORD_LOCKOUT","fns:QUERY_TIMEOUT","fns:QUERY_TOO_COMPLICATED","fns:REQUEST_LIMIT_EXCEEDED",
"fns:REQUEST_RUNNING_TOO_LONG","fns:SERVER_UNAVAILABLE","fns:SSO_SERVICE_DOWN","fns:TRIAL_EXPIRED",
"fns:UNKNOWN_EXCEPTION","fns:UNSUPPORTED_API_VERSION","fns:UNSUPPORTED_CLIENT"]
})
,
isc.XSComplexType.create({
ID:"ApiFault",
...
{location:"",namespace:"urn:partner.soap.sforce.com"},
{location:"",namespace:"urn:sobject.partner.soap.sforce.com"},
{location:"",namespace:"urn:fault.partner.soap.sforce.com"}
],
bindings:[
{
name:"SoapBinding",
...
soapAction:"",
inputHeaders:[
{encoding:"literal",message:"Header",part:"LoginScopeHeader"},
...
{encoding:"literal",message:"Header",part:"MruHeader"},
{encoding:"literal",message:"Header",part:"EmailHeader"}
]
},
{
inputEncoding:"literal",
...
{encoding:"literal",message:"Header",part:"SessionHeader"},
{encoding:"literal",message:"Header",part:"CallOptions"},
{encoding:"literal",message:"Header",part:"UserTerritoryDeleteHeader"}
]
},
{
inputEncoding:"literal",
...
portTypeName:"Soap",
operation:[
{inputMessage:"loginRequest",name:"login",outputMessage:"loginResponse"},
{inputMessage:"describeSObjectRequest",name:"describeSObject",
outputMessage:"describeSObjectResponse"},
{inputMessage:"describeSObjectsRequest",name:"describeSObjects",
outputMessage:"describeSObjectsResponse"},
{inputMessage:"describeGlobalRequest",name:"describeGlobal",
outputMessage:"describeGlobalResponse"},
{inputMessage:"describeLayoutRequest",name:"describeLayout",
outputMessage:"describeLayoutResponse"},
{inputMessage:"describeSoftphoneLayoutRequest",name:"describeSoftphoneLayout",
outputMessage:"describeSoftphoneLayoutResponse"},
{inputMessage:"describeTabsRequest",name:"describeTabs",
outputMessage:"describeTabsResponse"},
{inputMessage:"createRequest",name:"create",outputMessage:"createResponse"},
{inputMessage:"updateRequest",name:"update",outputMessage:"updateResponse"},
{inputMessage:"upsertRequest",name:"upsert",outputMessage:"upsertResponse"},
{inputMessage:"mergeRequest",name:"merge",outputMessage:"mergeResponse"},
{inputMessage:"deleteRequest",name:"delete",outputMessage:"deleteResponse"},
{inputMessage:"undeleteRequest",name:"undelete",outputMessage:"undeleteResponse"},
{inputMessage:"retrieveRequest",name:"retrieve",outputMessage:"retrieveResponse"},
{inputMessage:"processRequest",name:"process",outputMessage:"processResponse"},
{inputMessage:"convertLeadRequest",name:"convertLead",
outputMessage:"convertLeadResponse"},
{inputMessage:"getDeletedRequest",name:"getDeleted",
outputMessage:"getDeletedResponse"},
{inputMessage:"getUpdatedRequest",name:"getUpdated",
outputMessage:"getUpdatedResponse"},
{inputMessage:"queryRequest",name:"query",outputMessage:"queryResponse"},
{inputMessage:"queryAllRequest",name:"queryAll",outputMessage:"queryAllResponse"},
{inputMessage:"queryMoreRequest",name:"queryMore",outputMessage:"queryMoreResponse"},
{inputMessage:"searchRequest",name:"search",outputMessage:"searchResponse"},
{inputMessage:"getServerTimestampRequest",name:"getServerTimestamp",
outputMessage:"getServerTimestampResponse"},
{inputMessage:"setPasswordRequest",name:"setPassword",
outputMessage:"setPasswordResponse"},
{inputMessage:"resetPasswordRequest",name:"resetPassword",
outputMessage:"resetPasswordResponse"},
{inputMessage:"getUserInfoRequest",name:"getUserInfo",
...
ID:"message:Header",
fields:{
LoginScopeHeader:{name:"LoginScopeHeader",partName:"LoginScopeHeader",type:"LoginScopeHeader",
xmlRequired:true,xsElementRef:true},
SessionHeader:{name:"SessionHeader",partName:"SessionHeader",type:"SessionHeader",xmlRequired:true,
xsElementRef:true},
CallOptions:{name:"CallOptions",partName:"CallOptions",type:"CallOptions",xmlRequired:true,
xsElementRef:true},
QueryOptions:{name:"QueryOptions",partName:"QueryOptions",type:"QueryOptions",xmlRequired:true,
xsElementRef:true},
AssignmentRuleHeader:{name:"AssignmentRuleHeader",partName:"AssignmentRuleHeader",
type:"AssignmentRuleHeader",xmlRequired:true,xsElementRef:true},
MruHeader:{name:"MruHeader",partName:"MruHeader",type:"MruHeader",xmlRequired:true,
xsElementRef:true},
EmailHeader:{name:"EmailHeader",partName:"EmailHeader",type:"EmailHeader",xmlRequired:true,
xsElementRef:true},
UserTerritoryDeleteHeader:{name:"UserTerritoryDeleteHeader",partName:"UserTerritoryDeleteHeader",
type:"UserTerritoryDeleteHeader",xmlRequired:true,xsElementRef:true}
}
})
,
isc.WSDLMessage.create({
ID:"message:ApiFault",
fields:{
fault:{name:"fault",partName:"fault",type:"fault",xmlRequired:true,xsElementRef:true}
}
})
,
isc.WSDLMessage.create({
...
fields:{
LoginFault:{name:"LoginFault",partName:"fault",type:"LoginFault",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
InvalidQueryLocatorFault:{name:"InvalidQueryLocatorFault",partName:"fault",type:"InvalidQueryLocatorFault",
xmlRequired:true,xsElementRef:true}
}
})
,
...
fields:{
InvalidNewPasswordFault:{name:"InvalidNewPasswordFault",partName:"fault",type:"InvalidNewPasswordFault",
xmlRequired:true,xsElementRef:true}
}
})
,
...
fields:{
InvalidIdFault:{name:"InvalidIdFault",partName:"fault",type:"InvalidIdFault",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
UnexpectedErrorFault:{name:"UnexpectedErrorFault",partName:"fault",type:"UnexpectedErrorFault",
xmlRequired:true,xsElementRef:true}
}
})
,
...
fields:{
InvalidFieldFault:{name:"InvalidFieldFault",partName:"fault",type:"InvalidFieldFault",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
InvalidSObjectFault:{name:"InvalidSObjectFault",partName:"fault",type:"InvalidSObjectFault",
xmlRequired:true,xsElementRef:true}
}
})
,
...
fields:{
MalformedQueryFault:{name:"MalformedQueryFault",partName:"fault",type:"MalformedQueryFault",
xmlRequired:true,xsElementRef:true}
}
})
,
...
fields:{
MalformedSearchFault:{name:"MalformedSearchFault",partName:"fault",type:"MalformedSearchFault",
xmlRequired:true,xsElementRef:true}
}
})
,
...
fields:{
login:{name:"login",partName:"parameters",type:"login",xmlRequired:true,xsElementRef:true}
}
})
,
isc.WSDLMessage.create({
...
fields:{
loginResponse:{name:"loginResponse",partName:"parameters",type:"loginResponse",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
describeSObject:{name:"describeSObject",partName:"parameters",type:"describeSObject",
xmlRequired:true,xsElementRef:true}
}
})
,
...
fields:{
describeSObjectResponse:{name:"describeSObjectResponse",partName:"parameters",type:"describeSObjectResponse",
xmlRequired:true,xsElementRef:true}
}
})
,
...
fields:{
describeSObjects:{name:"describeSObjects",partName:"parameters",type:"describeSObjects",
xmlRequired:true,xsElementRef:true}
}
})
,
...
fields:{
describeSObjectsResponse:{name:"describeSObjectsResponse",partName:"parameters",
type:"describeSObjectsResponse",xmlRequired:true,xsElementRef:true}
}
})
,
isc.WSDLMessage.create({
...
fields:{
describeGlobal:{name:"describeGlobal",partName:"parameters",type:"describeGlobal",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
describeGlobalResponse:{name:"describeGlobalResponse",partName:"parameters",type:"describeGlobalResponse",
xmlRequired:true,xsElementRef:true}
}
})
,
...
fields:{
describeLayout:{name:"describeLayout",partName:"parameters",type:"describeLayout",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
describeLayoutResponse:{name:"describeLayoutResponse",partName:"parameters",type:"describeLayoutResponse",
xmlRequired:true,xsElementRef:true}
}
})
,
...
fields:{
describeSoftphoneLayout:{name:"describeSoftphoneLayout",partName:"parameters",type:"describeSoftphoneLayout",
xmlRequired:true,xsElementRef:true}
}
})
,
...
fields:{
describeSoftphoneLayoutResponse:{name:"describeSoftphoneLayoutResponse",partName:"parameters",
type:"describeSoftphoneLayoutResponse",xmlRequired:true,xsElementRef:true}
}
})
,
isc.WSDLMessage.create({
...
fields:{
describeTabs:{name:"describeTabs",partName:"parameters",type:"describeTabs",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
describeTabsResponse:{name:"describeTabsResponse",partName:"parameters",type:"describeTabsResponse",
xmlRequired:true,xsElementRef:true}
}
})
,
...
fields:{
create:{name:"create",partName:"parameters",type:"create",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
createResponse:{name:"createResponse",partName:"parameters",type:"createResponse",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
update:{name:"update",partName:"parameters",type:"update",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
updateResponse:{name:"updateResponse",partName:"parameters",type:"updateResponse",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
upsert:{name:"upsert",partName:"parameters",type:"upsert",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
upsertResponse:{name:"upsertResponse",partName:"parameters",type:"upsertResponse",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
merge:{name:"merge",partName:"parameters",type:"merge",xmlRequired:true,xsElementRef:true}
}
})
,
isc.WSDLMessage.create({
...
fields:{
mergeResponse:{name:"mergeResponse",partName:"parameters",type:"mergeResponse",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
"delete":{name:"delete",partName:"parameters",type:"delete",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
deleteResponse:{name:"deleteResponse",partName:"parameters",type:"deleteResponse",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
undelete:{name:"undelete",partName:"parameters",type:"undelete",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
undeleteResponse:{name:"undeleteResponse",partName:"parameters",type:"undeleteResponse",
xmlRequired:true,xsElementRef:true}
}
})
,
...
fields:{
retrieve:{name:"retrieve",partName:"parameters",type:"retrieve",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
retrieveResponse:{name:"retrieveResponse",partName:"parameters",type:"retrieveResponse",
xmlRequired:true,xsElementRef:true}
}
})
,
...
fields:{
process:{name:"process",partName:"parameters",type:"process",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
processResponse:{name:"processResponse",partName:"parameters",type:"processResponse",
xmlRequired:true,xsElementRef:true}
}
})
,
...
fields:{
convertLead:{name:"convertLead",partName:"parameters",type:"convertLead",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
convertLeadResponse:{name:"convertLeadResponse",partName:"parameters",type:"convertLeadResponse",
xmlRequired:true,xsElementRef:true}
}
})
,
...
fields:{
getDeleted:{name:"getDeleted",partName:"parameters",type:"getDeleted",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
getDeletedResponse:{name:"getDeletedResponse",partName:"parameters",type:"getDeletedResponse",
xmlRequired:true,xsElementRef:true}
}
})
,
...
fields:{
getUpdated:{name:"getUpdated",partName:"parameters",type:"getUpdated",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
getUpdatedResponse:{name:"getUpdatedResponse",partName:"parameters",type:"getUpdatedResponse",
xmlRequired:true,xsElementRef:true}
}
})
,
...
fields:{
query:{name:"query",partName:"parameters",type:"query",xmlRequired:true,xsElementRef:true}
}
})
,
isc.WSDLMessage.create({
...
fields:{
queryResponse:{name:"queryResponse",partName:"parameters",type:"queryResponse",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
queryAll:{name:"queryAll",partName:"parameters",type:"queryAll",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
queryAllResponse:{name:"queryAllResponse",partName:"parameters",type:"queryAllResponse",
xmlRequired:true,xsElementRef:true}
}
})
,
...
fields:{
queryMore:{name:"queryMore",partName:"parameters",type:"queryMore",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
queryMoreResponse:{name:"queryMoreResponse",partName:"parameters",type:"queryMoreResponse",
xmlRequired:true,xsElementRef:true}
}
})
,
...
fields:{
search:{name:"search",partName:"parameters",type:"search",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
searchResponse:{name:"searchResponse",partName:"parameters",type:"searchResponse",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
getServerTimestamp:{name:"getServerTimestamp",partName:"parameters",type:"getServerTimestamp",
xmlRequired:true,xsElementRef:true}
}
})
,
...
fields:{
getServerTimestampResponse:{name:"getServerTimestampResponse",partName:"parameters",
type:"getServerTimestampResponse",xmlRequired:true,xsElementRef:true}
}
})
,
isc.WSDLMessage.create({
...
fields:{
setPassword:{name:"setPassword",partName:"parameters",type:"setPassword",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
setPasswordResponse:{name:"setPasswordResponse",partName:"parameters",type:"setPasswordResponse",
xmlRequired:true,xsElementRef:true}
}
})
,
...
fields:{
resetPassword:{name:"resetPassword",partName:"parameters",type:"resetPassword",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
resetPasswordResponse:{name:"resetPasswordResponse",partName:"parameters",type:"resetPasswordResponse",
xmlRequired:true,xsElementRef:true}
}
})
,
...
fields:{
getUserInfo:{name:"getUserInfo",partName:"parameters",type:"getUserInfo",xmlRequired:true,
xsElementRef:true}
}
})
,
...
fields:{
getUserInfoResponse:{name:"getUserInfoResponse",partName:"parameters",type:"getUserInfoResponse",
xmlRequired:true,xsElementRef:true}
}
})
]
