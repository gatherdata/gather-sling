...
_1=_1||this.data;_2=(_2!=null)?_2:this.idField;_3=(_3!=null)?_3:this.parentIdField;_4=(_4!=null)?_4:this.rootValue;var _7=[];_7.addList(_1);for(var i=0;i<_7.length;i++){var _9=_7[i];if(_9==null)continue;var _10=_9[_3],_11=_10!=null?_7.find(_2,_10):null,_12=[];while(_11!=null){if(_11)_12.add(_11);_10=_11[_3];_11=_10!=null?_7.find(_2,_10):null}
if(_12.length>0){for(var _13=(_12.length-1);_13>=0;_13--){this.$640(_12[_13],_2,_3,_6,_4);_7[_7.indexOf(_12[_13])]=null}}
this.$640(_9,_2,_3,_6,_4);_7[i]=null}
this.$27f();this.dataChanged()}
,isc.A.$640=function(_1,_2,_3,_4,_5){var _6=this.logIsDebugEnabled(this.$64z);var _7=_1[_2],_8=_1[_3],_9=(_8==null||_8==-1||_8===isc.emptyString),_10=this.nodeIndex[_8];if(_10){if(_6){this.logDebug("found parent "+_10[_2]+" for child "+_1[_2],this.$64z)}
this.$27e(_1,_10)}else if(_8==_5){if(_6){this.logDebug("root node: "+_1[_2],this.$64z)}
this.$27e(_1,this.root)}else{if(!_9&&this.discardParentlessNodes){this.logWarn("Couldn't find parent: "+_8+" for node with id:"+_7,this.$64z)}else{var _11=_4||this.root;if(_6){this.logDebug("child:"+_1[_2]+(_9?" has no explicit parent ":(" unable to find specified parent:"+_8))+"- linking to default node "+_11[_2],this.$64z)}
this.$27e(_1,_11)}}}
...
return _2}
,isc.A.changeDataVisibility=function(_1,_2,_3){if(this.isLeaf(_1))return false;_1[this.openProperty]=_2;this.$27f();if(_2&&!this.isLoaded(_1)){this.loadChildren(_1,_3)}}
...
return _5}
);isc.B._maxIndex=isc.C+84;isc.ClassFactory.defineClass("Selection");isc.A=isc.Selection.getPrototype();isc.A.enabledProperty="enabled";isc.A.$q7=true;isc.A=isc.Selection;isc.A.NONE="none";isc.A.SINGLE="single";isc.A.MULTIPLE="multiple";isc.A.SIMPLE="simple";isc.A.$24e=0;isc.A=isc.Selection.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.selectionRangeNotLoadedMessage="Can't select that many records at once.<br><br>"+"Please try working in smaller batches.";isc.B.push(isc.A.init=function(){if(!this.selectionProperty)this.selectionProperty="_selection_"+isc.Selection.$24e++;this.setData((this.data?this.data:[]))}
...
this.$q7=false}
,isc.A.setSelected=function(_1,_2){if(_1==null)return false;if(_1[this.enabledProperty]==false)return false;var _3=this.selectionProperty,_4=isc.isAn.XMLNode(_1);if(_2==null)_2=true;var _5=_4?_1.getAttribute(_3):_1[_3];if(_5==null)_5=false;if(_4){_1.setAttribute(_3,(_2==true)+"")}else{_1[_3]=_2}
...
_12=_2.getCellStyle(_11,_2,_6,this);else _12=(this.getCellStyle(_11,_2,_6,this)||this.cellStyle);var _13=" style='";if(this.clipValues)_13+="overflow:hidden;";_13+="text-align:"+this.valueAlign;if(this.getCellCSSText){var _14=this.getCellCSSText(_11,_2,_6,this);if(_14!=null)_13+=";"+_14}
...
if(!this.$568||_2==0){_17.append("<TABLE BORDER=0",_26,(!_5?" ID="+this.getTableElementId():null),(this.tableStyle&&isc.Browser.isDOM?" CLASS='"+this.tableStyle+this.$ob:isc.$ad)," CELLSPACING=",this.cellSpacing," CELLPADDING=",this.cellPadding," STYLE='",(isc.Browser.isDOM&&!_25&&this.fixedColumnWidths?"table-layout:fixed;overflow:hidden;wrap:false;":""),(!_16?_23+(this.isRTL()?"-right: ":"-left:")+_20+"px;"+_23+(this.isRTL()?"-left:":"-right:")+_21+"px;":""),(this.cacheDOM&&this.$514>0?"margin-top:"+this.$514+"px;":""),(this.$27y!=null&&!(isc.Browser.isIE&&this.$r9)?"visibility:hidden;":""),"'>",(isc.Browser.isMoz?"<TBODY>":""));var _29=0,_30=0,_31=this.$54p();if(isc.Browser.isStrict&&(isc.Browser.isSafari||isc.Browser.isIE)){if((isc.Browser.isIE&&isc.Browser.version<8)||(isc.Browser.isSafari&&isc.Browser.safariVersion<530))
{_30=this.$54q()}
...
if(!_2.$29a)_2.$29a=[];_2.$29a.add(_1);if(this.$29a==null)this.$29a=[];this.$29a.add(_1);_1.embeddedPosition=_5;_1.embeddedRecord=_2;_1.$289=_3;_1.$57n=_4;_1.$669=this.getID();_1.percentBox="custom";if(_1.parentElement!=this){_1.hide();this.addChild(_1)}
if(_5==this.$57m){this.observe(_1,"resized","if(deltaY!=null&&deltaY!=0)observer.markForRedraw('embedded component resized')")}
_1.$29b=_1._redrawWithParent;_1._redrawWithParent=false;_1.$668=_1.bubbleMouseEvents;if(!_1.bubbleMouseEvents)_1.bubbleMouseEvents=false;if(_7&&(_3==-1||_4==-1)){_7=false}
...
var _3=_1.embeddedRecord,_4=_1.embeddedPosition,_5=_1.$57n,_6=this.getRowTop(_2),_7=_5!=null?this.getColumnLeft(_5):0,_8=_5!=null?this.getColumnWidth(_5):this.$26a.sum();if(_4==this.$57l){var _9=_1.snapTo||"TL",_10=_1.snapEdge||_9;var _11=this.getRowSize(_2),_12=_1._percent_width,_13=_1._percent_height,_14,_15;if(isc.isA.String(_12)&&_12.endsWith("%")){_14=Math.round((parseInt(_12)*_8)/100)}
...
isc.Canvas.snapToEdge([_7,_6,_8,_11],_9,_1,_10)}else{_6+=this.cellHeight;_1.moveTo(_7,_6);if(_5!=null)_1.setWidth(_8)}
...
,isc.A.removeEmbeddedComponent=function(_1,_2,_3){if(isc.isA.Number(_1))_1=this.getCellRecord(_1,0);var _4=_1.$29a;if(_4==null)return;if(isc.isA.Number(_2))_2=_4.find("$57n",_2);if(!_4.contains(_2))return;if(this.isObserving(_2,"resized")){this.ignore(_2,"resized")}
_1.$29a.remove(_2);if(_1.$29a.length==0)_1.$29a=null;this.$29a.remove(_2);_2._redrawWithParent=_2.$29b;_2.$29b=null;_2.bubbleMouseEvents=_2.$668;var _5=_2.embeddedPosition==this.$57m;_2.embeddedPosition=null;_2.$289=null;_2.$57n=null;_2.$669=null;if(_3){_2.hide();return}
...
return _5}
);isc.evalBoundary;isc.B.push(isc.A.shouldRefreshCellHTML=function(_1,_2,_3){return this.showHiliteInCells}
...
if(_8&&!_10&&_31!=null){_31+=this.getHBorderPad()+this.getHMarginSize();if(_15||this.alwaysShowVScrollbar){_31+=this.getScrollbarSize();if(this.autoFitMaxWidth){var _32=this.autoFitMaxWidth;if(_9)_32=Math.max(20,_32-_26);_31=Math.min(_32,_31)}}
if(_31>_12){_12=_31;this.$70v=true}else{if(this.$70v)delete this.$70v}}
_17=this.getDelta(this.$o5,_11,this.getHeight());_16=this.getDelta(this.$o6,_12,this.getWidth());if(_17!=null||_16!=null)this.resizeBy(_16,_17,null,null,true);if(_16!=null||(_10&&_8)){var _33=this.grid,_34=(_12-(_15?_33.getScrollbarSize():0)),_35=_34;if(_9&&_33.headerLayout){if(_10){_35=this.getWidth()+_33.body.getWidth();if(_33.autoFitMaxWidth!=null&&(_35+_33.getHBorderPad()+_33.getHMarginSize()>_33.autoFitMaxWidth))
{return _33.body.adjustOverflow()}
_35-=(_33.body.vscrollOn?_33.getScrollbarSize():0)}else{_35=_34+_33.frozenBody.getWidth()}
_33.headerLayout.setWidth(_35)}
if(!_10){var _36=_33.header;if(_36&&_36.isDrawn()){_36.setWidth(_34)}}
if(_33.sorter&&_33.$313()&&!_33.isRTL()){_33.sorter.moveTo(_35);if(!_33.sorter.isVisible())_33.sorter.show()}else if(_33.sorter){_33.sorter.setLeft(0-_33.sorter.getWidth())}}}
var _37=(!_7&&this.$70u),_38=(!_8&&this.$70v);if(_37||_38){delete this.$70u;delete this.$70v;var _39=_37?this.grid.getAutoFitMinBodyHeight():null,_40=_38?(!_9?this.grid.getInnerWidth():(this.grid.getInnerWidth()-this.grid.frozenBody.getWidth())):null;this.resizeTo(_12,_11);this.grid.$45m("autoFitData mode changed")}
return this.invokeSuper(isc.GridBody,"adjustOverflow",_1,_2,_3,_4,_5)}
...
,isc.A.selectOnMouseDown=function(_1,_2,_3){var _4=this.grid.getCheckboxFieldPosition(),_5=this.grid.selectionAppearance;if(_5!="checkbox"||(_5=="checkbox"&&_4==_3)){this.invokeSuper(isc.GridBody,"selectOnMouseDown",_1,_2,_3)}}
...
return _2}
,isc.A.updateRowSelection=function(_1){var _2=this.grid;if(_2&&_2.showSelectionCanvas)_2.updateSelectionCanvas();if(_2&&!_2.$67j){this.invokeSuper(isc.GridBody,"updateRowSelection",_1)}
if(_2&&_2.getCurrentCheckboxField()!=null){var _3=_2.getCheckboxFieldPosition();if(_2&&!_2.$67j)this.refreshCell(_1,_3);var _4=(isc.isAn.Array(_2.data)||(isc.isA.ResultSet(_2.data)&&_2.data.allMatchingRowsCached()));if(_4&&_2.getSelection.length==_2.data.getLength()){_2.$63m(true)}else if(_4){_2.$63m(false)}}}
...
if(this.canEditNew)this.listEndEditAction=this.rowEndEditAction="new";if(this.alwaysShowEditors){this.editByCell=false;this.selectionType="none";this.selectOnEdit=false;if(this.canGroup!=false){this.logInfo("grouping functionality is not supported when alwaysShowEditors is true."+" Explicitly disabling this.canGroup","inactiveEditorHTML");this.canGroup=false}
...
if(this.canSort&&this.$60z()!=null){this.sortData()}
...
if(this.body)this.body.finishRowAnimation();if(!this.$31o)this.$31n();if(this.$686()&&!this.$30a){this.startEditing()}
...
,isc.A.applyFieldDefaults=function(_1){if(_1==null)return;for(var i=0;i<_1.length;i++){var _3=_1[i];if(_3==null)continue;if(_3[this.fieldIdProperty]==null){if(_3.dataPath==null){this.logWarn("unable to process field with no name / dataPath:"+this.echo(_3));continue}
...
var _4=this.fields.indexOf(_3),_5=this.getFieldName(_4);var _6=this.$60z();if(_6==_4){this.unsort()}else if(_6!=null&&_6>_4){this.$600(_6-1)}
...
if(_11==null||_11[0]!=_8){this.cancelEditing(isc.ListGrid.PROGRAMMATIC);_7=false}else{this.$31u(_11[0],_11[1],!this.getEditForm().hasFocus)}}else if(this.getEditCol()>_4){this.$30u-=1}}}
...
var _2=this.$60z(),_3=(_2!=null&&this.fields?this.fields[_2]:null);var _4=this.$30a,_5=this.getEditRow(),_6=this.getEditCol(),_7=this.$286,_8=this.fields?this.getEditFieldName():null;if(this.completeFields==null)this.fields=[];this.completeFields=this.bindToDataSource(_1);if(this.completeFields==null)this.completeFields=[];if(this.shouldShowCheckboxField()){var _9=this.getCurrentCheckboxField(),_10=this.getCheckboxFieldPosition(),_11=!_9,_12=this.completeFields.findAll("frozen",true),_13=_12&&(_12.length>1||(_12.length==1&&_12[0][this.fieldIdProperty]!="$63n"));if(_11)_9=this.getCheckboxField();if(_13)_9.frozen=true;else if(_9.frozen)_9.frozen=false;if(_11)this.completeFields.addAt(_9,_10);else this.completeFields.slideList([_9],_10)}
if(this.canRemoveRecords){var _14=this.completeFields.findIndex("isRemoveField",true),_15=(_14>=0)?this.completeFields[_14]:{isRemoveField:true};if(!_15.$61a){isc.addProperties(_15,this.removeFieldDefaults,this.removeFieldProperties);if(_15.name==null)_15.name="$61b";if(_15.cellIcon==null)_15.cellIcon=this.removeIcon;if(_14==-1){this.completeFields.add(_15)}
_15.$61a=true}}
if(isc.DataSource)this.$45n();if(this.fieldState!=null)this.setFieldState();this.applyFieldDefaults(this.completeFields);this.completeFields.$696=true;this.completeFields.setProperty("$697",true);this.deriveVisibleFields();if(this.fields.length==0){var _16=this.completeFields.length>0;if(!_16){this.logWarn("This component has no specified fields. In order to display data "+"fields must be set up either via an explicit call to setFields() or "+"by binding to a dataSource.")}else{this.logWarn("All specified fields for this component are hidden. Note that fields "+"may be hidden via 'showIf' or 'detail' attribute values. "+"In order to display data this grid must have some visible fields.")}}
this.$26a=null;var _17,_18,_19;if(_4){this.storeUpdatedEditorValue();_17=this.fields.findIndex(this.fieldIdProperty,_8);if(_17!=-1&&!this.canEditCell(_5,_17))
_17=-1;if(_17==-1){var _20;if(!this.editByCell)_20=this.findNextEditCell(_5,0,1,true,true,false,true);if(_20!=null&&_20[0]==_5){_17=_20[1]}
if(_17==-1){this.cancelEditing(isc.ListGrid.PROGRAMMATIC);_4=false}}else{var _21=_7.getItem(_8);if(_21){_19=_21.hasFocus;if(_19)_7.$106()}
_18=true}
if(_4)this.hideInlineEditor(false,true)}
var _22=(this.canFreezeFields==null||this.$60v)&&this.fixedRecordHeights!=false&&this.fixedFieldWidths!=false&&this.autoFitData!="horizontal"&&this.autoFitData!="both"&&this.bodyOverflow!="visible";if(_22){if(this.completeFields.getProperty("overflow").contains("visible"))_22=false}
if(_22){this.$60v=true;this.canFreezeFields=true}else if(this.$60v){delete this.$60v;this.canFreezeFields=null}
if(this.canSelectCells)this.selection.numCols=this.fields.length;if(_3){var _23=this.fields.indexOf(_3);if(_23==-1)_23=null;this.$600(_23)}
...
this.updateBody();this.layoutChildren(this.$604);if(this.$52b!=null){var _24={};for(var i in this.$52b){if(this.$52b[i]==null)continue;var _26=this.$52b[i].$31x,_27=(this.dataSource!=null?this.getDataSource().getPrimaryKeyFieldNames():[]);for(var _28 in _26){if(!this.fields.containsProperty(this.fieldIdProperty,_28)&&!_27.contains(_28)){_24[_28]=true;this.clearEditValue(_26,_28,true)}}}
_24=isc.getKeys(_24);if(_24.length>0){this.logInfo("'setFields()' removed the following fields which had pending edit "+"values for some row[s]: '"+_24.join("', '")+"'.\n"+"Edit values for these fields have been dropped.","gridEdit")}}
if(_4){if(_18){this.showInlineEditor(_5,_17,false,false,true);if(_19)_7.$11b(_29)}else{this.$31u(_5,_17,!_19)}
if(_19){var _29=this.getEditFieldName();if(_29==_8){_7.$11b(_29)}else{_7.focusInItem(_29)}}}
...
,isc.A.shouldShowCheckboxField=function(){return(this.selectionAppearance==this.$12c&&this.selectionType!=this.$27r)}
...
,isc.A.getCheckboxFieldPosition=function(){if(this.selectionAppearance!="checkbox")return-1;return 0}
...
);isc.evalBoundary;isc.B.push(isc.A.$311=function(_1,_2,_3){if(!this.body)return _1;var _4=(_3?this.body.getBottomBorderSize()+this.body.getBottomMargin():this.body.getRightBorderSize()+this.body.getRightMargin());if(_4!=0){var _5=_2-
...
return this.recordSummaryBaseStyle;if(_4&&_4.frozen&&this.frozenBaseStyle)return this.frozenBaseStyle;if(this.isPrinting&&(this.printBaseStyle!=null))return this.printBaseStyle;var _5=this.baseStyle;if(_5==null){if(this.cellHeight!=isc.ListGrid.getPrototype().cellHeight||!this.shouldFixRowHeight(_1,_2))
...
_1=this.$300(_2,_3)}
if(_1&&_1[this.isSeparatorProperty])return this.$302;if(_1&&_1.$52e)return this.getGroupNodeHTML(_1,_4);var _5=this.fields[_3],_6=null;if(_5==null)return"";if(this.isCheckboxField(_5)){var _7=this.selection.isSelected(_1)?true:false;var _8=_7?(this.checkboxFieldTrueImage||this.booleanTrueImage):(this.checkboxFieldFalseImage||this.booleanFalseImage)
var _9=this.getValueIconHTML(_8,_5);return _9}
var _8,_10=this.showValueIconOnly(_5),_11;if(_1!=null){if(_1[this.singleCellValueProperty]!=null){return _1[this.singleCellValueProperty]}
...
_8=this.getValueIcon(_5,_6,_1,_2);if(!_10){var _15=_5.valueMap;if(_15){if(isc.isA.String(_15))_15=this.getGlobalReference(_15);if(!isc.isAn.Array(_15))_6=isc.getValueForKey(_6,_15)}}
if(_13)_6=_12}}
...
var _6=this.fields[_4];if(_6.userFormula||_6.userSummary){return this.isRTL()?isc.Canvas.LEFT:isc.Canvas.RIGHT}
...
,isc.A.$67c=function(_1){var _2=_1.$68q,_3=_1.$68n,_4=_1.$51u;if(_4==null||_4.length==0){this.logWarn("$67c fired for dataSource:"+_3+" which no longer applies to any fields in this ListGrid");return}
for(var i=0;i<_4.length;i++){var _6=_4[i],_7=(_6.valueField||_6[this.fieldIdProperty]),_8=_2.getValueMap(_7,_6.displayField);if(this.getField(_6[this.fieldIdProperty])==null){_6.valueMap=_8}else{this.setValueMap(_6[this.fieldIdProperty],_8)}}}
...
,isc.A.$67a=function(){if(this.$45o==null)return;for(var i=0;i<this.$45o;i++){var _2=this.$45o[i].$68q;if(_2)_2.destroy()}
delete this.$45o}
...
);isc.evalBoundary;isc.B.push(isc.A.bodyScrolled=function(_1,_2,_3){for(var i=0;i<this.bodies.length;i++){if(this.bodies[i]!=_3)this.bodies[i].scrollTo(null,_2,null,true)}
...
if(!this.isDirty())this.markForRedraw();if(this.showGridSummary&&this.summaryRow)this.summaryRow.recalculateSummaries()}
...
,isc.A.showSummaryRow=function(){if(this.summaryRow&&this.summaryRow.masterElement==this)return;if(!this.summaryRow){this.summaryRow=this.createAutoChild("summaryRow",{warnOnReusedFields:false,autoDraw:false,top:this.getBottom()-this.summaryRowHeight,left:this.getLeft()+this.getLeftMargin(),showHeader:false,height:this.summaryRowHeight,getBaseStyle:function(){return this.creator.summaryRowStyle},disabled:this.disabled,width:this.getWidth(),bodyOverflow:"hidden",getTotalRows:function(){return 1},recalculateSummaries:function(){delete this.$71q;this.markForRedraw();return this.getRecord(0)},getCellRecord:function(_7,_8){if(_7!=0)return null;if(this.$71q){return this.$71q}
this.$71q={};this.$71q[this.creator.gridSummaryRecordProperty]=true;var _1=this.completeFields||this.fields,_2=[];for(var i=0;i<_1.length;i++){var _4=_1[i],_5=_1[i].name;if(!this.creator.shouldShowGridSummary(_4))continue;this.$71q[_5]=this.creator.getGridSummary(_4)}
return this.$71q},fields:this.completeFields.duplicate(),$315:function(_7,_8,_4,_9,_10){var _6=this.creator;if(_6.shouldShowGridSummary(_4)){if(_7==null)return this.invalidSummaryValue;if(_4.formatGridSummary){if(!isc.isA.Function(_4.formatGridSummary)){_4.formatGridSummary=isc.Func.expressionToFunction("value",_4.formatGridSummary)}
if(isc.isA.Function(_4.formatGridSummary)){return _4.formatGridSummary(_7)}}}
return this.Super("$315",arguments)},$jo:false,$ns:true,masterResized:function(_7,_8){if(_7!=null)this.resizeBy(_7);if(_8!=null)this.moveBy(null,_8)}});this.addPeer(this.summaryRow)}else{this.summaryRow.setFields(this.completeFields.duplicate());this.summaryRow.moveTo(this.getBottom()-this.summaryRowHeight);this.summaryRow.setLeft(this.getLeft()+this.getLeftMargin());this.summaryRow.setWidth(this.getWidth());this.summaryRow.recalculateSummaries();this.addPeer(this.summaryRow);this.summaryRow.setBodyFieldWidths(this.$26a.duplicate());this.syncSummaryRowScrolling(this.body.getScrollLeft(),this.body.getScrollTop)}
...
,isc.A.getFilterEditorCriteria=function(){if(this.filterEditor){return this.filterEditor.getValues()}}
...
if(this.editByCell){this.refreshCell(_1,_2)}else{var _8=this.getDrawnFields();for(var i=0;i<_8.length;i++){if(this.isCheckboxField(_8[i]))continue;var _10=_8[i][this.fieldIdProperty],_11=this.$286.getItem(_10),_2=_11.colNum,_12=!!(_4&&_11.isDrawn()),_13=this.canEditCell(_1,_2);if(_12!=_13)this.refreshCell(_1,_2);else if(this.selectOnEdit||this.lastOverRow){var _7=this.getField(_10).frozen?this.frozenBody:this.body;_7.$29h(this.getCellRecord(_1,_2),_1,_2)}}}}
...
);isc.evalBoundary;isc.B.push(isc.A.$51o=function(){this.Super("focusInItem",arguments);this.grid.$51n(this)}
...
this.body.markForRedraw("clear edit values, remove row")}}else if(_5!=null&&!_3){var _12={},_13=this.data.get(_5);for(var _14 in _6.$31x){_12[_14]=_13?_13[_14]:null}
...
if(this.isGrouped){var _9=this.getFieldName(_2);if(this.groupByField==_9||this.groupByField.contains(_9)){this.regroup();if(!this.isDirty())this.markForRedraw()}}}
...
);isc.evalBoundary;isc.B.push(isc.A.$335=function(_1,_2,_3,_4,_5){if(!_5){delete this.$334[_2];delete this.$333[_2];return}
...
,isc.A.deriveFrozenFields=function(){var _1=this.frozenFields=this.fields.findAll("frozen",true);if(_1&&_1.length==1&&this.isCheckboxField(_1[0])){var _2=_1[0];_2.frozen=false;_1=this.frozenFields=null;this.completeFields.slideList([_2],this.getCheckboxFieldPosition())}
var _3=this.completeFields.findAll("frozen",true);if(_1&&_1.length==this.fields.length){_1=this.frozenFields=null;this.$54d=true}else this.$54d=false;if(_1){var _2=this.getCurrentCheckboxField();if(_2&&!_2.frozen){_2.frozen=true;_1.addAt(_2,this.freezeLeft()?0:this.fields.length);_3.addAt(_2,this.freezeLeft()?0:this.completeFields.length)}
this.fields.slideList(_1,this.freezeLeft()?0:this.fields.length);this.completeFields.slideList(_3,this.freezeLeft()?0:this.completeFields.length);this.resizeFieldsInRealTime=false}
for(var i=0;i<this.fields.length;i++){var _5=this.fields[i];_5.masterIndex=i}
if(_1){var _6=this.normalFields=[];for(var i=0;i<this.fields.length;i++){var _5=this.fields[i];if(!_5.frozen)_6.add(_5)}}else this.normalFields=null}
...
);isc.evalBoundary;isc.B.push(isc.A.updateEmbeddedComponentZIndex=function(_1){if(!_1)return;if(this.selectionCanvas==_1){var _2=this.body.getTableZIndex();this.selectionCanvas.setZIndex(_2+50)}
...
{this.$63m(true)}}
return false}
if(this.canSort==false||!_3||this.$66c(_3)==false)return false;if(_1==this.$60z()){if(this.canUnsort&&_3.sortDirection!=isc.ListGrid.getInstanceProperty("sortDirection")){this.unsort()}else{var _4=_3.sortDirection==null?this.sortDirection:_3.sortDirection;this.sort(_1,!Array.shouldSortAscending(_4))}}else{this.sort(_1)}
return false}
...
,isc.A.reorderFields=function(_1,_2,_3){if(this.showFilterEditor){this.filterEditor.reorderFields(_1,_2,_3)}
if(this.summaryRow&&this.showGridSummary){this.summaryRow.reorderFields(_1,_2,_3)}
var _4=this.fields[_1],_5=this.fields[_2-1],_6=_1+_3,_7=this.fields[_6];var _8=this.$60z(),_9=this.fields[_8];this.$26a.slideRange(_1,_2,_1+_3);if(this.completeFields.contains(_7)){var _10=this.completeFields.indexOf(_4),_11=this.completeFields.indexOf(_5)+1,_12=this.completeFields.indexOf(_7);this.completeFields.slideRange(_10,_11,_12)}
...
,isc.A.displayHeaderContextMenu=function(_1,_2){if(!_1)return;var _3=this.fields[_1.masterIndex];if(this.isCheckboxField(_3))return false;var _4=this.getHeaderContextMenuItems(_1.masterIndex);if(_4.length==0)return;if(!this.$314)this.$314=this.getHeaderContextMenu(_1);this.$314.setData(_4);if(_2!=null&&_2.length>0){this.$314.placeNear(_2[0],_2[1]);this.$314.show();return false}else{return this.$314.showContextMenu(_1)}}
...
,isc.A.addEmbeddedComponent=function(_1,_2,_3,_4,_5){var _6=this.getFieldBody(_4),_4=this.getLocalFieldNum(_4);_6.addEmbeddedComponent(_1,_2,_3,_4,_5)}
,isc.A.removeEmbeddedComponent=function(_1,_2,_3){var _4;if(isc.isA.Number(_2)){_4=this.getFieldBody(_2);_2=this.getLocalFieldNum(_2)}else{_4=isc.Canvas.getById(_2.$669)}
...
var _21=this.groupTree.getRoot(),_22=0,_23=0,_24=this.groupTree;while(_21!=null&&_23<this.groupByField.length){var _25=_24.getChildren(_21);for(var i=0;i<_25.length;i++){var _26=(this.completeFields||this.fields).find(this.fieldIdProperty,this.groupByField[_23]);var _27=_26.getGroupTitle?"false":!_26.getGroupValue?(_26.$62&&_26.$62.getGroupTitle)?"true":null:null;var _28=_25[i];if(_27=="false"){_28.singleCellValue=_26.getGroupTitle(_28.groupValue,_28,_26,_26.name,this)}
else if(_27=="true"){_28.singleCellValue=_26.$62.getGroupTitle(_28.groupValue,_28,_26,_26.name,this)}}
...
if(this.groupTree.getChildren(_5)==null)_4=null;else _4=this.groupTree.getChildren(_5).find('groupValue',_11);if(!_4){_4={singleCellValue:_11,groupName:_7,groupValue:_11,$52e:true,canDrag:false};_4[_7]=_11;_4[this.recordCustomStyleProperty]=this.groupNodeStyle
...
_5=_4}
this.groupTree.add(_1,_5);if(_2){var _12=this.groupTree.getParents(_1);for(var i=_12.length-2,j=0;i>=0;i--,j++){var _14=(this.completeFields||this.fields).find(this.fieldIdProperty,this.groupByField[j]);var _15=_14.getGroupTitle?"false":!_14.getGroupValue?(_14.$62&&_14.$62.getGroupTitle)?"true":null:null;if(_15=="false"){var _16=_12[i];_16.singleCellValue=_14.getGroupTitle(_16.groupValue,_16,_14,_14.name,this)}
else if(_15=="true"){var _16=_12[i];_16.singleCellValue=_14.$62.getGroupTitle(_16.groupValue,_16,_14,_14.name,this)}}}}
...
,isc.A.refreshGroupSummary=function(_1){if(!this.isGrouped||!this.showGroupSummary||!this.groupTree)return;this.groupTree.$27f();if(_1==null){this.body.markForRedraw()}else{var _2=this.groupTree.getParent(this.groupTree.get(_1));if(_2){var _3=this.groupTree.indexOf(_2)+this.groupTree.getChildren(_2).length;this.refreshRow(_3)}}}
...
,isc.A.$342=function(_1,_2,_3,_4,_5,_6,_7){if(_7==null)_7=this.getCellCSSText(_2,_3,_4);if(_6==null)_6=this.getCellStyle(_2,_3,_4);var _8=this.$34q;_8[1]=_7;_8[3]=_6;if(_5){var _9=this.getOpenIcon(_2),_10=this.openerIconSize||(this.showConnectors?this.cellHeight:null),_11=(_3!=null?this.$34l+_3:null);if(_9){_8[5]=this.getIconHTML(_9,_11,_10)}else{_8[5]=this.$348(_10||this.iconSize)}}else _8[5]=null;var _12=this.getExtraIcon(_2),_13=(_3!=null?this.$349+_3:null),_14=this.getIcon(_2),_15=(_3!=null?this.$34n+_3:null);_8[6]=(_12?this.getIconHTML(_12,_13):null);_8[7]=this.getIconHTML(_14,_15,_2.iconSize);_8[9]=_7;_8[11]=this.iconPadding;_8[13]=_6;_8[15]=this.wrapCells?null:"<NOBR>"
_8[16]=_1;return _8}
...
,isc.A.performFilter=function(_1){var _2=this.$286.getValuesAsCriteria(true),_3=isc.addProperties({},this.sourceWidget.data.criteria);var _4=[];var _5=this.$286.getItems();for(var i=0;i<_5.length;i++){var _7=_5[i];if(_7.displayField){_4.add(_7.name);_4.add(_7.displayField)}}
var _8;for(var _9 in _3){if(_4.contains(_9))_3[_9]=_8}
for(var _10 in _3){if(_2[_10]===_8)_2[_10]=_3[_10]}
_2=isc.DataSource.filterCriteriaForFormValues(_2);var _11={};if(_1)_11.showPrompt=false;_11.textMatchStyle=this.sourceWidget.autoFetchTextMatchStyle;var _12=this.sourceWidget.data;if(isc.isA.ResultSet(_12)&&_12.willFetchData(_2,_11.textMatchStyle)){this.fireOnPause("performFilter",{target:this.sourceWidget,methodName:"fetchData",args:[_2,null,_11]},this.fetchDelay)}else{this.sourceWidget.fetchData(_2,null,_11)}}
...
,isc.A.getCellValue=function(_1,_2,_3,_4){var _5=this.fields[_3];if(_5&&this.isCheckboxField(_5))return"&nbsp;"
...
,isc.A.handleClick=function(){if(this.Super("handleClick",arguments)==false)return;if(this.$359)return;this.showMenu()}
...
_4.add(this.menu.getItemTitle(_1));return _4.join(this.pathSeparatorString)}}else{return this.unselectedTitle}}
...
_15+=_23+_19}}else{this.logDebug("starting fit layout","TileLayout");var _28=this.getTilesPerLine();var _29=this.getTileHeight();var _30=this.getTileWidth();var _13=this.orientation=="horizontal";var _31,_32,_33;var _34,_35,_36,_37,_38,_39;if(this.shouldUseIncrRendering()){var _40=this.getVisibleTiles();this.$57r=_40;_35=_40[0];_34=_11;var _41=this.getVisibleLines();_38=_41[0];_39=_41[0]+_41[1];if(!this.hasAllVisibleTiles(_40,true))return}else{_34=_11;_35=0;_38=0;_39=Math.ceil(_34/ _28);_31=this.getTileHMargin();_32=this.getTileVMargin()}
...
return _1}
,isc.A.processTile=function(_1,_2,_3,_4,_5){var _6;if(this.$35v){if(isc.isA.Canvas(_1))_6=_1;else _6=this.getRecordTile(_1);if(!_6)return;if(this.$584.findIndex("ID",_6.ID)==-1)return;if(!_6)return;if(_4)_6.setHeight(_4);if(_5)_6.setWidth(_5);if(_6.getTop()!=_2||_6.getLeft()!=_3){_6.$589=_2;_6.$588=_3;this.$586.add(_6)}
...
,isc.A.reLayout=function(){if(this.destroying)return;if(this.animateTileChange){isc.Timer.setTimeout(this.ID+".$583()",200)}else{this.layoutTiles()}}
...
if(this.completeFields==null)this.fields=[];this.completeFields=this.bindToDataSource(_1);if(this.completeFields==null)this.completeFields=[];if(!this.completeFields)return;this.deriveVisibleFields();this.detailViewer.fields=this.completeFields.duplicate();if(!_2)this.layoutTiles()}
,isc.A.deriveVisibleFields=function(){this.fields.setArray(this.getVisibleFields(this.completeFields))}
,isc.A.getVisibleFields=function(_1){var _2=_1.duplicate();for(var i=0;i<_1.length;i++){var _4=_1.get(i);if(!this.fieldShouldBeVisible(_4)||_4.visible==false)_2.remove(_4)}
return _2}
...
,isc.A.hasAllVisibleTiles=function(_1,_2){if(isc.isA.ResultSet(this.data)){var _3=_1[1]+1;if(_3>this.data.getLength())_3=this.data.getLength();if(this.data.rangeIsLoaded(_1[0],_3)){return true}else{if(_2){this.data.getRange(_1[0],_3)}
return false}}else{return true}}
...
return _4}
,isc.A.getUsedFieldsFromValue=function(_1,_2,_3){var _4=_1,_5=this.getFieldIdProperty(_3),_6=[];for(var _7 in _4){var _8=_4[_7],_9=_2.findIndex(_5,_8);if(!_2[_9]){isc.logWarn("Field "+_8+" is not in the list of available-fields")}else{var _10=isc.addProperties({},_2[_9]);_10.mappingKey=_7;_6.add(_10)}}
return _6}
...
_4[_7[_3]]=_7[_3]}}
return _4}
,isc.A.generateFunction=function(_1,_2,_3){var _4=isc.SB.create(),_5=_1.text,_6=this.getFieldIdProperty(_3),_7=this.getUsedFieldsFromValue(_1.formulaVars,_2,_3);_7=_7.sortByProperties(["mappingKey"],[false]);if(_7.length>0){_4.append("var ");for(var i=0;i<_7.length;i++){var _9=_7.get(i);if(i>0)_4.append("        ");_4.append(_9.mappingKey,"= (record['",_9[_6],"'] ? ","record['",_9[_6],"'] : component ? ","component.getSpecificFieldValue(record, '",_9[_6],"', true) : 0)");_4.append(i==_7.length-1?";":",","\n");if(_1.allowEscapedKeys){_5=_5.replaceAll("#"+_9.mappingKey,_9.mappingKey);_5=_5.replaceAll("#{"+_9.mappingKey+"}",_9.mappingKey)}}
_4.append("\n")}
var _10=isc.MathFunction.getRegisteredFunctions();if(_10.length>0){_4.append("var functions=isc.MathFunction.getRegisteredFunctionIndex(),\n");for(var i=0;i<_10.length;i++){var _9=_10.get(i);_4.append("        ");_4.append(_9.name,"=","functions.",_9.name,".jsFunction");_4.append(i==_10.length-1?";":",","\n")}
_4.append("\n")}
_4.append("return ",_5,";");var _11=_4.toString();var _12=new Function("record,component",_11);return _12}
...
return _5}
,isc.A.generateFunction=function(_1,_2,_3){var _4=isc.SB.create(),_5=_1.text,_6=this.getFieldIdProperty(_3),_7=this.getUsedFieldsFromValue(_1.summaryVars,_2,_3);_7=_7.sortByProperties(["mappingKey"],[false]);if(_7.length>0){_4.append("var ");for(var i=0;i<_7.length;i++){var _9=_7.get(i);if(i>0)_4.append("        ");_4.append(_9.mappingKey,"=(component ? component.getSpecificFieldValue(record,'",_9[_6],"') : record['",_9[_6],"']");_4.append(i==_7.length-1?");":"),","\n");_5=_5.replaceAll("#{"+_9.mappingKey+"}","'+"+_9.mappingKey+"+'");_5=_5.replaceAll("#"+_9.mappingKey,"'+"+_9.mappingKey+"+'")}
_4.append("\n")}
